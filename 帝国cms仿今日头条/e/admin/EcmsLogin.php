<?php
/********密码验证***********/
$password='RqlYDl2j';				                   //这个密码是登陆验证用的.您需要在模块里设置和这里一样的密码....注意一定需要修改.
if($password!=$_GET['pw']) exit('验证密码错误');   //安全检测,密码不符则退出  火车头免登陆接口，www.dede168.com提示请勿随意修改
echo '<ccc>'.time().'</ccc>';
/****以下代码非专业人员不建议修改***************/
...
if(strpos($_POST['title'],'淘宝')!==false || strpos($_POST['title'],'天猫')!==false || strpos($_POST['title'],'阿里巴巴')!==false){
	exit('标题有禁止的关键字');
}
