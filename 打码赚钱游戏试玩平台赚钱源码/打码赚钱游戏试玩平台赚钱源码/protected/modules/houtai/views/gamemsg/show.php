    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function search(name) {
                $("#submitForm").attr("action", "<?php echo SITE_URL ?>houtai/gamemsg/show").submit();
            }
            ...
            function deleteSelected() {
                ...
                if (arr.length > 0) {
                    if (confirm("确认删除选中吗？")) {
                        $("#submitForm").attr("action", "<?php echo SITE_URL ?>houtai/gamemsg/alldel/ids/" + arr.substr(0, arr.length - 1)).submit();
                    }
                } else {
    ...
    <body>
        ...
        <div id="container">
            <div class="ui_content">
                <div class="ui_text_indent">
                    <div id="box_border">
                        ...
                        <div id="box_center">
                            游戏名称&nbsp;&nbsp;<input type="text" id="name" name="name" class="ui_input_txt02" value="<?php echo $pages->params['name']; ?>"/>
                        </div>
                        <div id="box_bottom">
            ...
            <div class="ui_content">
                ...
                <div>结果：（0成功）（1缺少参数）（2游戏不存在）（3注册时间到了）（4此会员不存在）（5此账号已经绑定过）</div>
            </div>
        </div>
        <?php $this->endWidget(); ?>
       </body>
