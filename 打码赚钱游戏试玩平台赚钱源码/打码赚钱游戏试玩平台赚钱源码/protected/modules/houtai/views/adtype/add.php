...
<html>
    ...
    <body>
       <?php $form = $this->beginWidget('CActiveForm');?>
        <div id="container">
            <div id="nav_links">
                当前位置：广告分类&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table class="tab_1" cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" >
                    <tr>
                        <td class="ui_text_rt"><?php echo $form->labelEx($adtype_model, 'name'); ?></td>
                        <td class="ui_text_lt">
                            <?php echo $form->textField($adtype_model, 'name'); ?>
                            <?php echo $form->error($adtype_model, 'name'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
