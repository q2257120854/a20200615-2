        ...
        <script type="text/javascript">
            ...
            function del(fyID) {
                if (fyID == '')
                    return;
                if (confirm("您确定要删除吗？")) {
                    $("#submitForm").attr("action", "<?php echo SITE_URL ?>houtai/expadgrade/del/expadid/<?php echo $pages->params['expadid']; ?>/id/" + fyID).submit();
                }
            }
            ...
            function deleteSelected() {
                ...
                if (arr.length > 0) {
                    if (confirm("确认删除选中吗？")) {
                        $("#submitForm").attr("action", "<?php echo SITE_URL ?>houtai/expadgrade/alldel/expadid/<?php echo $pages->params['expadid']; ?>/ids/" + arr.substr(0, arr.length - 1)).submit();
                    }
                } else {
            ...
            var expadid =<?php echo $pages->params['expadid']; ?>;
            $(document).ready(function() {
                $("#addBtn").fancybox({
                    'href': '<?php echo SITE_URL; ?>houtai/expadgrade/add/expadid/' + expadid,
                    'width': 733,
                    'height': 600,
                    'type': 'iframe',
                    ...
                    'onClosed': function() {
                        window.location.href = '<?php echo SITE_URL; ?>houtai/expadgrade/show/expadid/' + expadid;
                    }
                });
                /**编辑   **/
                $("a.edit").fancybox({
                    ...
                    <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0" id="dataTab">
                        ...
                        foreach ($posts as $model) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo SITE_URL ?>houtai/expadgrade/edit/id/<?php echo $model['id']; ?>" class="edit">编辑</a> 
