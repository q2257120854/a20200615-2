...
?>';
    ...
    <body>
        ...
        <div id="container">
            <div id="nav_links">
                当前位置：兑换管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">备注</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table  cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" class="tab_1">
                    <tr>
                        <td class="ui_text_rt"><?php echo $form->labelEx($giftdh_model, 'remark'); ?></td>
                        <td class="ui_text_lt ipn_1">
                            <?php echo $form->textField($giftdh_model, 'remark', array('autocomplete' => 'off')); ?>
                            <?php echo $form->error($giftdh_model, 'remark'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
