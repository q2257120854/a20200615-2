...
<html>
    ...
    <body>
        ...
        <div id="container">
            <div id="nav_links">
                当前位置：体验商家&nbsp;>&nbsp;<span style="color: #1A5CC6;">编辑</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table  cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" class="tab_1">
                    <tr>
                        <td class="ui_text_rt"><?php echo $form->labelEx($expadbus_model, 'name'); ?></td>
                        <td class="ui_text_lt">
                            <?php echo $form->textField($expadbus_model, 'name'); ?>
                            <?php echo $form->error($expadbus_model, 'name'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
