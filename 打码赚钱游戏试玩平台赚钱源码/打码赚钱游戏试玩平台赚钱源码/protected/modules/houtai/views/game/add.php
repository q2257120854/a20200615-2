...
?>';
    ...
    <body>
        ...
        <div id="container">
            <div id="nav_links">
                当前位置：游戏管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table class="tab_1" cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" >
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($game_model, 'color', array("value" => "#FFF")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($game_model, 'gamezmbs', array("value" => 3)); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt ">
                            <?php echo $form->textField($game_model, 'json_servername', array("value" => "servername")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt ">
                            <?php echo $form->textField($game_model, 'json_role', array("value" => "role")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt ">
                            <?php echo $form->textField($game_model, 'json_level', array("value" => "level")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt ">
                            <?php echo $form->textField($game_model, 'json_payment', array("value" => "payment")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt ">
                            <?php echo $form->textField($game_model, 'hlz_uid', array("value" => "44wl_uid")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt ">
                            <?php echo $form->textField($game_model, 'game_uid', array("value" => "game_uid")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($game_model, 'networklevel', array("value" => "level")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($game_model, 'networknickname', array("value" => "nickname")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($game_model, 'networkuptime', array("value" => "uptime")); ?>
