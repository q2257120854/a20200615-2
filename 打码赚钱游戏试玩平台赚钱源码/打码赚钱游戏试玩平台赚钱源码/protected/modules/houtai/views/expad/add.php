...
?>';
    ...
    <body>
        ...
        <div id="container">
            <div id="nav_links">
                当前位置：体验管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table class="tab_1"  cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" >
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($expad_model, 'hlz_uid', array("value" => "hlz_uid")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($expad_model, 'hlz_expid', array("value" => "hlz_expid")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->textField($expad_model, 'expad_uid', array("value" => "expad_uid")); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <input type="text"  id="Expad_begin_time" name="Expad[begin_time]" class="ui_input_txt02" />
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <input type="text"  id="Expad_end_time" name="Expad[end_time]" class="ui_input_txt02" />
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <input type="text"  id="Expad_zc_end_time" name="Expad[zc_end_time]" class="ui_input_txt02" />
                            <?php echo $form->error($expad_model, 'end_time'); ?>
                        </td>
                    </tr>
                    <tr>
