...
?>';
    ...
    <body>
        ...
        <div id="container">
            <div id="nav_links">
                当前位置：账号管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table class="tab_1"  cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" >
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->passwordField($account_model, 'password', array('autocomplete' => 'off')); ?>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <?php echo $form->passwordField($account_model, 'password2', array('autocomplete' => 'off')); ?>
