...
?>';
    ...
    <body>
        ...
        <div id="container">
            <div id="nav_links">
                当前位置：合作商家&nbsp;>&nbsp;<span style="color: #1A5CC6;">新增</span>
                <div id="page_close">
            ...
            <div class="ui_content">
                <table class="tab_1" cellspacing="0" cellpadding="0" width="100%"  align="left" border="0" >
                    <tr>
                        <td class="ui_text_rt"><?php echo $form->labelEx($bank_model, 'name'); ?></td>
                        <td class="ui_text_lt">
                            <?php echo $form->textField($bank_model, 'name'); ?>
                            <?php echo $form->error($bank_model, 'name'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
