...
.wrw_nav {
 ...
 <div class="wrw_navBgr">
  ...
  <a href="<?php echo SITE_URL ?>expad/show" class="selected">任务吧</a>   
...
<iframe src="http://list.offer8.cn/index?appid=offer8561b7e3a6aff9&uid=<?php echo $mem['id']; ?>" style="width:1040px;height:1560px;  " frameborder="no" border="0" allowtransparency="true" >
                      </iframe>
					   </div>
