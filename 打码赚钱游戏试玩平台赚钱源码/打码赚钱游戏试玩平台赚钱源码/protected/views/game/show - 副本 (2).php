            ...
            <div class="main_left clearfix">
                ...
                <div class="mainSlider clearfix">
                    <ul class="spotlightBanner">
                        <?php
                        $ad_info = Ad::model()->findAllBySql("select img,url,hlb_num,name from {{ad}} where id in(5,6,7,8) and open =0 order by orderby limit 0,1; ");
                        if (!empty($ad_info)) {
                        ...
                        ?>
                        <?php
                        $ad_infos = Ad::model()->findAllBySql("select img,url,hlb_num,name from {{ad}} where id in(5,6,7,8) and open =0  order by orderby limit 1,3 ;");
                        if (!empty($ad_infos)) {
                ...
                <div class="game clearfix">
                    <div class="tit clearfix">
                        <ul class="ul_1 clearfix">
                            ...
                            <?php
                            $gametype_info = Gametype::model()->findAllBySql("select id,name from {{game_type}}  limit 0,3;");
