    ...
    ?> no-repeat top center ;">
        ...
        <div class="main">
            <div class="game_bk">
                ...
                <?php
                if (!empty($game_info->impactmax)) {
                    $impactmax = $game_info["impactmax"];
                } else {
                    $impactmax = $gameimpact_model->countBySql("select hlb FROM {{game_impact}} where game_id=" . $game_info["id"] . " order by rank limit 1");
                }
                $gradenum = $gamegrade_model->countBySql("select sum(hlb) FROM {{game_grade}} where game_id=" . $game_info["id"]);
            ...
            <div class="step clearfix">
                <div class="zhuc">
                    ...
                    if (strtotime($game_info['end_time']) < time()) {
                        ?>
                        <a href="javascript:" class="button_4 butt"></a><!--试玩结束-->
                        <?php
                    } else {
                        if ($game_info['recruit_num'] >= $num) {
                            if ($mem['id'] != 0) {
                                ...
                                <?php } else { ?>
                                    <a target="_black" href="<?php echo SITE_URL . "game/jump/type/3/id/" . $game_info["id"]; ?>"  class="button_1 butt"></a><!--立即试玩-->
                                    <?php
                                }
                            } else {
                                ?>
            ...
            <div class="content clearfix">
                <div class="content_left">
                    ...
                    <div class="information">
                        ...
                        <div class="cont">
                            ...
                            if (!empty($mem)) {
                                if (!empty($gamezm)) {
                                    $info2 = $gamedata_model->findBySql("select * from {{game_data}} where game_id=" . $game_info['id'] . " and mem_id=" . $mem['id'])
                                    ?>
                                ...
                                <?php } else { ?>
                                    <p>
                                        <span >您还未注册本游戏，请</span>
                                        <a target="_black" href="<?php echo SITE_URL . "game/jump/type/3/id/" . $game_info["id"]; ?>" class="button_1 butt">立即注册试玩账号</a><!--立即试玩-->
                                    </p>
                                    <?php
                                }
                            } else {
                ...
                <div class="content_right">
                    ...
                    <div class="award">
                        ...
                        <div class="cont">
                            ...
                            <table class="table_2" border="1">
                                ...
                                <?php
                                $gamegrade_info = $gamegrade_model->findAllBySql("select * from {{game_grade}} where game_id=" . $game_info['id'] . " order by level ");
                    ...
                    <?php
                    //联网冲级比赛
                    if (!empty($game_info->networkurl)) {
                        $result = file_get_contents($game_info["networkurl"]);
                        $cjdata = json_decode($result);
                        ?>
                        <div class="match">
                            <div class="tit_1 clearfix">
                                <span class="ioc_8">冲级比赛</span>
                            ...
                            <div class="cont">
                                <table class="table_2" border="1">
                                    ...
                                    <?php
                                    foreach ($cjdata as $index => $data) {
                                        ?>
                                        <tr>
                                            <td align="center"><?php echo $index + 1; ?></td>
                                            <td align="center"><?php echo $data->$game_info['networklevel'] ?></td>
                                            <td align="center">
                                                <?php echo $data->$game_info['networknickname']; ?>
                                            </td>
                                            <td align="center">
                                                <?php echo $data->$game_info['networkuptime']; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </table>
                    ...
                    <div class="regulations">
                        ...
                        <div class="cont">
                            ...
                            <p>创建试玩账号昵称、角色名、公会或联盟名称不得跟、网络内容相关；</p>
