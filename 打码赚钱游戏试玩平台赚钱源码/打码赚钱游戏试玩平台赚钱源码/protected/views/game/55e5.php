...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>《<?php echo $game_info['name']; ?>》游戏试玩-《<?php echo $game_info['name']; ?>》游戏冲级赛-、官方网站</title>
        ...
        <div class="main">
           <!--<div class="game_bk">
                    ...
                    if (strtotime($game_info['end_time']) < time() || $game_info["game_start"] != 0) {
                        ...
                        if ($game_info['recruit_num'] > $num || $game_info["zc_start"] != 0) {
                            if ($mem['id'] != 0) {
                                ...
                                <?php } else {
                                    ?>
                                    <a target="_black" href="<?php echo SITE_URL . "game/jump/type/1/id/" . $game_info["id"]; ?>" class="button_1 butt"></a><!--立即试玩-->
                                    <?php
                                }
                            } else {
                                ?>
            ...
            <div class="content clearfix">
                <div class="content_left">
                    ...
                    <div class="information">
                        ...
                        <div class="cont">
                            ...
                            if ($mem != 0) {
                                if ($gamezm != 0) {
                                    $info2 = Gamedata::model()->findBySql("select * from {{game_data}} where game_id=" . $game_info['id'] . " and mem_id=" . $mem['id'] . " order by level desc ")
                                    ?>
                                    ...
                                    <?php } ?>
                                    <p class="but">
                                        <a class="ann"  href="javascript:grade(<?php echo $mem['id']; ?>,<?php echo $game_info["id"]; ?>)">刷新试玩信息</a>
                                        <img src="<?php echo IMG_URL ?>img/loading.gif" id="ref"  style="display:none"/>
                                    </p>
                                <?php } else { ?>
                                    <p><span >您还未注册本游戏，请</span>
                                        <a target="_black" href="<?php echo SITE_URL . "game/jump/type/1/id/" . $game_info["id"]; ?>" class="button_1 butt">立即注册试玩账号</a><!--立即试玩-->
                                    </p>
                                    <?php
                                }
                            } else {
				...
				<div class="countdown">
					<div class="tit_1 clearfix">
					<span class="ioc_2">游戏商展示</span>
					</div>
					<!--游戏logo-->
                <div class="game_logo">
                    <span class="img" style="background:url(/uploads/img/game/<?php echo $game_info['logoimg']; ?>) no-repeat"></span>  
                </div>
			</div>
                    <!--试玩倒计时-->
                    <div class="countdown">
                        ...
                        <div class="rebate">
                            ...
                            <div class="cont">
                                ...
                                <p class="ann clearfix">
                                    ...
                                    <a href="/message/list/pid/5" class="chak">查看充值返利情况<i>>></i></a>
                                </p>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="qq_group">
                        ...
                        <div class="cont">
                            <p class="clearfix"><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=62f73e8d9ee8d535aa583944177f7937e33866cdd12a5b14f35fa4917f5d8935"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="、综合交流①群" title="、综合交流①群"></a>【、①群】48999940</p>
							<p class="clearfix"><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=7038992e8fc7e91a53ee64514fd314f99f242758356c25b997bbdb9ea250e9e3"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="、综合交流②群" title="、综合交流②群"></a>【、②群】48999980</p>
                        </div>
                    </div>
                    <!--游戏介绍-->
                            ...
                            <table class="table_2" border="1">
                                ...
                                foreach ($gamegrade_info as $index => $gradeinfo) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><?php if ($gradeinfo['name'] == null) { ?>
                                                   体验等级达到&nbsp; 
                                             <?php } else if($gradeinfo['name']) { ?>
                                                     <?php echo $gradeinfo['name']; ?>&nbsp; <?php } ?>	
										...
										<i><?php echo $gradeinfo['level']; ?></i>&nbsp;
										
										
										
										
										
											<?php if ($gradeinfo['zhi'] == null) { ?>
                                                   级 
                                             <?php } else if($gradeinfo['zhi']) { ?>
                                                     <?php echo $gradeinfo['zhi']; ?> <?php } ?>	</td>
                   ...
                   <!-- <div class="screenshot">
                    ...
                    <div class="regulations">
                        ...
                        <div class="cont">
                            ...
                            <p>严禁注册多个51账号试玩或体验广告，以非法获取元宝奖励；</p>
