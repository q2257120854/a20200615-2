                ...
                <div class="cont prizes">
                    ...
                    <div class="switch clearfix" style=" margin-top:10px;">
                        <ul class="ul_2 clearfix">
                            <li class="hover" style="border-left:1px solid #bdbcbd;"><a href="<?php echo SITE_URL ?>vipadvance/txalipay">支付宝提现</a></li>
                        ...
                        if (!empty($mem["jy_pwd"])) {
                            if (!empty($alipay_info)) {
                                ...
                                <div class="alipay clearfix">
                                    ...
                                    <input type="hidden" value="<?php echo $alipay_info["account"]; ?>" name="Tx[account]"/>
                                    <input type="hidden" value="<?php echo $alipay_info["name"]; ?>"  name="Tx[name]"/>
                                    <ul class="ul_1 clearfix">
                                        <li class="clearfix">
                                            <span class="name">支付宝账号：</span>
                                            <span class="text_1">
                                                <input type="text" class="sframe inp_1"  value="<?php echo $alipay_info["account"]; ?>"   disabled="disabled" />
                                            </span>
                                        </li>
                                        <li class="clearfix">
                                            <span class="name">支付宝姓名：</span>
                                            <span class="text_1">
                                                <input type="text" class="sframe inp_1" value="<?php echo $alipay_info["name"]; ?>"   disabled="disabled" />
                                            </span>
                                        </li>
                            ...
                            <?php } else { ?>
                                <span>您还没有绑定支付宝,不能用支付宝提现!</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo SITE_URL ?>vipadvance/alipay" ><span style="color:red">立即绑定支付宝</span></a>
                            <?php } ?>
                            <?php
                        } else {
                            ?>
