...
?>";
            ...
            window.onload = function() {
                ...
                if (msg != null) {
                    alert(msg);
                    location.href = "<?php echo SITE_URL ?>vipadvance/treasure";
                }
            }</script>
    </head>
    <body>
                ...
                <div class="cont prizes">
                    ...
                    <div class="switch clearfix" style=" margin-top:20px;">
                        <ul class="ul_2 clearfix">
                            ...
                            <li class="hover"><a href="<?php echo SITE_URL; ?>vipadvance/treasure"><?php if (empty($mem['treasureid'])) { ?>绑定<?php } else { ?>修改<?php } ?>我的财付通</a></li>
                    ...
                    <?php } ?>
                    <?php
                    if (empty($mem['treasureid']) || !empty($treasure_model['id'])) {
                        $form = $this->beginWidget('CActiveForm', array('id' => 'dhform'))
                        ?>
                        <input type="hidden" id="Treasure_num" name="Treasure[num]" value="<?php echo $num; ?>"/>   
                        <input type="hidden" value="<?php echo $mem['id']; ?>" id="Treasure_mem_id" name="Treasure[mem_id]"/>
                        <div class="alipay">
                            <ul class="ul_1">
                                <li class="clearfix">
                                    <span class="name">真实姓名：</span>
                                    <span class="text_1">
                                        <?php echo $form->textField($treasure_model, 'name', array('class' => 'sframe inp_1')); ?>
                                    </span>
                                    <span class="zs"><i>*</i>请务必填写您的真实姓名</span>
                                </li>
                                <li class="tishi" style="display:block;"><?php echo $form->error($treasure_model, 'name'); ?></li>
                                <li class="clearfix">
                                    <span class="name">账号：</span>
                                    <span class="text_1">
                                        <?php echo $form->textField($treasure_model, 'account', array('class' => 'sframe inp_2')); ?>
                                    </span>
                                    <span class="zs"><i>*</i>请输入财付通登陆账号</span> 
                                </li>
                                <li class="tishi" style="display:block;"><?php echo $form->error($treasure_model, 'account'); ?></li>
                                <li class="clearfix">
                                    <span class="name">确认账号：</span>
                                    <span class="text_1">
                                        <?php echo $form->textField($treasure_model, 'account2', array('class' => 'sframe inp_2')); ?>
                                    </span>
                                    <span class="zs"><i>*</i>请再次输入财付通登陆账号</span> 
                                </li>
                                <li class="tishi" style="display:block;"><?php echo $form->error($treasure_model, 'account2'); ?></li>
                                <li class="clearfix">
                                    <span class="name">验证码：</span>
                                    <span class="text_1 clearfix" style=" width: auto;">
                                        <?php echo $form->textField($treasure_model, 'code', array('class' => 'sframe inp_1', 'size' => 6)); ?>
                                ...
                                <li class="tishi" style="display:block;"><?php echo $form->error($treasure_model, 'code'); ?></li>
                                <li>
                        ...
                        <div class="already">
                            ...
                            <table class="table_2" width="100%" border="1">
                                ...
                                if (!empty($mem['treasureid'])) {
                                    $treasureinfo = Treasure::model()->findByPk($mem['treasureid']);
                                    ?>
                                    <tr>
                                        <td align="center" valign="middle"><?php echo $treasureinfo['name'] ?></td>
                                        <td align="center" valign="middle">财付通</td>
                                        <td align="center" valign="middle">财付通</td>
                                        <td align="center" valign="middle"><?php echo $treasureinfo['account'] ?></td>
                                        <td align="center" valign="middle"><a class="xiu" href="<?php echo SITE_URL ?>vipadvance/edittreasure/id/<?php echo $treasureinfo['id'] ?>">修改</a></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
