...
?>";
            ...
            window.onload = function() {
                ...
                if (msg != null) {
                    alert(msg);
                    location.href = "<?php echo SITE_URL ?>vipadvance/bank";
                }
            }
        </script>
    </head>
                ...
                <div class="cont prizes">
                    ...
                    <div class="switch clearfix" style=" margin-top:20px;">
                        <ul class="ul_2 clearfix">
                            <li  style="border-left:1px solid #bdbcbd;"><a href="<?php echo SITE_URL; ?>vipadvance/alipay"><?php if (empty($mem['alipayid'])) { ?>绑定<?php } else { ?>修改<?php } ?>我的支付宝</a></li>
                            <li><a href="<?php echo SITE_URL; ?>vipadvance/treasure"><?php if (empty($mem['treasureid'])) { ?>绑定<?php } else { ?>修改<?php } ?>我的财付通</a></li>
                            <li class="hover"><a href="<?php echo SITE_URL; ?>vipadvance/bank"><?php if (empty($mem['bankid'])) { ?>绑定<?php } else { ?>修改<?php } ?>我的银行卡</a></li>
                        </ul>
                    </div>
                    <?php
                    //判断是否有提示信息
                    ...
                    <?php } ?>
                    <?php
                    if (empty($mem['bankid']) || ! empty($bank_model['id'])) {
                    $form = $this->beginWidget('CActiveForm', array('id' => 'dhform'))
                    ?>
                    <input type="hidden" id="Bank_num" name="Bank[num]" value="<?php echo $num; ?>"/>   
                    <input type="hidden" value="<?php echo $mem['id']; ?>" id="Bank_mem_id" name="Bank[mem_id]"/>
                    <div class="alipay">
                        <ul class="ul_1">
                            <li class="clearfix">
                                <span class="name">真实姓名：</span>
                                <span class="text_1">
                                    <?php echo $form->textField($bank_model, 'name', array('class' =>   'sframe inp_1')); ?>
                                        </span>
                                        <span class="zs"><i>*</i>请务必填写您的真实姓名</span>
                                    </li>
                                    <li class="tishi" style="display:block;"><?php echo $form->error($bank_model, 'name'); ?></li>
                                    <li class="clearfix">
                                        <span class="name">银行：</span>
                                        <span class="text_1">
                                            <select class="sframe inp_1" id="Bank_bank" name="Bank[bank]">
                                        ...
                                        <span class="zs"><i>*</i>请选择相关银行</span> 
                                    </li>
                                    <li class="tishi" style="display:block;"><?php echo $form->error($bank_model, 'bank'); ?></li>
                                    <li class="clearfix">
                                        <span class="name">开户行：</span>
                                        <span class="text_1">
                                            <?php echo $form->textField($bank_model, 'banksub', array  ('class' => 'sframe inp_2')); ?>
                                </span>
                                <span class="zs"><i>*</i>请务必填写您的开户行详细详细</span>
                            </li>
                            <li class="tishi" style="display:block;">  <?php echo $form->error($bank_model, 'banksub'); ?></li>
                                    <li class="clearfix">
                                        <span class="name">卡号：</span>
                                        <span class="text_1">
                                            <?php echo $form->textField($bank_model, 'account', array ('class' => 'sframe inp_2', 'size' => 19)); ?>
                                </span>
                                <span class="zs"><i>*</i>请输入银行卡号</span>
                            </li>
                            <li class="tishi" style="display:block;">  <?php echo $form->error($bank_model, 'account'); ?></li>
                                    <li class="clearfix">
                                        <span class="name">确认卡号：</span>
                                        <span class="text_1">
                                            <?php echo $form->textField($bank_model, 'account2', array  ('class' => 'sframe inp_2', 'size' => 19)); ?>
                                </span>
                                <span class="zs"><i>*</i>请再次输入银行卡号</span>
                            </li>
                            <li class="tishi" style="display:block;">  <?php echo $form->error($bank_model, 'account2'); ?></li>
                                    <li class="clearfix">
                                        <span class="name">验证码：</span>
                                        <span class="text_1 clearfix" style=" width: auto;">
                                            <?php echo $form->textField($bank_model, 'code', array  ('class' => 'sframe inp_1')); ?>
                            ...
                            <li  id="tishi" style="display:none">
                                <span>您还未绑定邮箱,</span><a href="  <?php echo SITE_URL ?>vipindex/thirdly" target="_blank"><span style="color:red">立即绑定邮箱</span></a>
                                    ...
                                    <li class="tishi" style="display:block;"><?php echo $form->error($bank_model, 'code'); ?></li>
                                    <li>
                    ...
                    <div class="already">
                        ...
                        <table class="table_2" width="100%" border="1">
                            ...
                            <?php
                            if (!empty($mem['bankid'])) {
                            $bankinfo = Bank::model()->findByPk($mem['bankid']);
                            ?>
                            <tr>
                                <td align="center" valign="middle"><?php echo $bankinfo['name'] ?></td>
                                                <td align="center" valign="middle"><?php echo $bankinfo['bank'] ?></td>
                                        <td align="center" valign="middle"><?php echo $bankinfo['banksub'] ?></td>
                                <td align="center" valign="middle"><?php echo $bankinfo['account'] ?></td>  
                                <td align="center" valign="middle"><a class="xiu" href="<?php echo SITE_URL ?>vipadvance/editbank/id/<?php echo $bankinfo['id'] ?>">修改</a></td>
                            </tr>
                            <?php } ?>
                        </table>
                    </div>
