...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <div class="cont prizes">
                    ...
                    <div class="switch clearfix" style=" margin-top:10px;">
                        <ul class="ul_2 clearfix">
                            ...
                            <li ><a href="<?php echo SITE_URL ?>vipadvance/txtreasure">财付通提现</a></li>
                            <li  class="hover" style="border-left:1px solid #bdbcbd;"><a href="<?php echo SITE_URL ?>vipadvance/txbank">银行卡提现</a></li>
                        </ul>
                    </div>
                    <?php
                    ...
                    <div class="alipay clearfix">
                        ...
                        <input type="hidden" value="<?php echo $bank_info["account"]; ?>" name="Tx[account]"/>
                        <input type="hidden" value="<?php echo $bank_info["name"]; ?>"  name="Tx[name]"/>
                        <ul class="ul_1 clearfix">
                            <li class="clearfix">
                                <span class="name">银行：</span>
                                <span class="text_1">
                                    <input type="text" class="sframe inp_1"  value="<?php echo $bank_info["bank"]; ?>"   disabled="disabled" />
                                </span>
                            </li>
                            <li class="clearfix">
                                <span class="name">支行：</span>
                                <span class="text_1">
                                    <input type="text" class="sframe inp_1" value="<?php echo $bank_info["banksub"]; ?>"   disabled="disabled" />
                                </span>
                            </li>
                            <li class="clearfix">
                                <span class="name">姓名：</span>
                                <span class="text_1">
                                    <input type="text" class="sframe inp_1"  value="<?php echo $bank_info["account"]; ?>"   disabled="disabled" />
                                </span>
                            </li>
                            <li class="clearfix">
                                <span class="name">账号：</span>
                                <span class="text_1">
                                    <input type="text" class="sframe inp_1" value="<?php echo $bank_info["name"]; ?>"   disabled="disabled" />
                                </span>
                            </li>
                            <li class="clearfix" id="con_tow_1">
                                <span class="name">提现金额：</span>
                                <span class="text_1">
                                    <select class="sframe inp_1" name="Tx[applymoney]" id="Tx_applymoney" > 
                    ...
                    <?php } else { ?>
                    <span>您还没有绑定银行卡,不能用银行卡提现!</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo SITE_URL ?>vipadvance/bank" ><span style="color:red">立即绑定银行卡</span></a>
                    <?php } ?>
                    <?php
                    } else {
                    ?>
    ...
    <?php include_once("./protected/views/vipdesign/footer.php"); ?>
        ...
        <div class="eject_db4" style="display:none" id="msgsuc">
            ...
            <!--申请提现成功弹出框-->
            <div class="eject3" style="display:block">
