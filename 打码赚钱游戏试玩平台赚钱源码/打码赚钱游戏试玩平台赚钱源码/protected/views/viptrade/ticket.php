        ...
        <div class="main clearfix">
            ...
            <div class="public_db clearfix">
                ...
                <div class="cont prizes"  >
                    <form id="selfrom" method="get" action="<?php echo SITE_URL ?>viptrade/ticket/data/<?php echo $data; ?>">
                        <!--起始时间选择-->
                        <div class="demo3 clearfix">
                            ...
                            <div class="xuanz">
                                <a href="<?php echo SITE_URL ?>viptrade/ticket/data/<?php echo $pages->params['data']; ?>/time/1" >今天</a>
                                <a href="<?php echo SITE_URL ?>viptrade/ticket/data/<?php echo $pages->params['data']; ?>/time/7" >最近7天</a>
                                <a href="<?php echo SITE_URL ?>viptrade/ticket/data/<?php echo $pages->params['data']; ?>/time/30" >最近30天</a>
                                <a href="<?php echo SITE_URL ?>viptrade/ticket/data/<?php echo $pages->params['data']; ?>/time/90" >最近3个月</a>
                            </div>
                        </div>
                        <!--切换-->
                        <div class="switch clearfix">
                            <ul class="ul_2 clearfix">
                                ...
                                ?>><a href="<?php echo SITE_URL ?>viptrade/ticket/data/1" >充值记录</a></li>
                                <li <?php
                                if ($data == 2) {
                                    echo "class='hover'";
                                }
                                ?>><a href="<?php echo SITE_URL ?>viptrade/ticket/data/2" >保证金明细</a></li>
                                <li <?php
                                if ($data == 3) {
                                    echo "class='hover'";
                                }
                                ?>><a href="<?php echo SITE_URL ?>viptrade/ticket/data/3" >提现记录</a></li>
                            </ul>
                        </div>
                    </form>
                    您好 ，该功能暂时未开通！
                    <!--表格-->
                    <table class="table_2" width="100%" border="1" style="display:none">
                        <tr class="tit">
                            <th>发生时间</th>
                            <th>发生原因</th>
                            <th>金券变化</th>
                        ...
                        foreach ($posts as $model) {
                            ...
                            <tr>
                                ...
                                <td align="center" valign="middle"><span class="juan"><?php echo number_format($model['hlq']); ?></span></td>
                                <td align="center" valign="middle"><span class="juan"><?php echo number_format($model['hlq']); ?> </span></td>
                            </tr>
                        <?php } ?>
                    </table>
                    <!--上一页、下一页-->
                    <br/>
                    <div  style="text-align: center;height: 30px; display:none" >
                        <?php
