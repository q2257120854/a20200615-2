        ...
        <div class="main clearfix">
            ...
            <div class="public_db clearfix">
                ...
                <div class="cont prizes">
                    <form id="selfrom" method="get" action="<?php echo SITE_URL ?>viptrade/bean/data/<?php echo $data; ?>">
                        <!--起始时间选择-->
                        <div class="demo3 clearfix">
                            ...
                            <div class="xuanz">
                                <a href="<?php echo SITE_URL ?>viptrade/bean/data/<?php echo $pages->params['data']; ?>/time/1" >今天</a>
                                <a href="<?php echo SITE_URL ?>viptrade/bean/data/<?php echo $pages->params['data']; ?>/time/7" >最近7天</a>
                                <a href="<?php echo SITE_URL ?>viptrade/bean/data/<?php echo $pages->params['data']; ?>/time/30" >最近30天</a>
                                <a href="<?php echo SITE_URL ?>viptrade/bean/data/<?php echo $pages->params['data']; ?>/time/90" >最近3个月</a>
                            </div>
                        </div>
                        <!--切换-->
                        <div class="switch clearfix">
                            <ul class="ul_2 clearfix">
                                ...
                                ?> style=" border-left:1px solid #bdbcbd;"><a href="<?php echo SITE_URL ?>viptrade/bean/data/0" >全部</a></li>
                                <li <?php
                                if ($data == 1) {
                                    echo "class='hover'";
                                }
                                ?>><a href="<?php echo SITE_URL ?>viptrade/bean/data/1" >收入明细</a></li>
                                <li <?php
                                if ($data == 2) {
                                    echo "class='hover'";
                                }
                                ?>><a href="<?php echo SITE_URL ?>viptrade/bean/data/2" >支出明细</a></li>
                            </ul>
                        </div>
                    </form>
                    <!--表格-->
                    <table class="table_2" width="100%" border="1">
                        ...
                        foreach ($posts as $model) {
                            ...
                            <tr>
                                ...
                                <td align="center" valign="middle"><span class="bi"><?php echo number_format($model['hld']); ?></span></td>
