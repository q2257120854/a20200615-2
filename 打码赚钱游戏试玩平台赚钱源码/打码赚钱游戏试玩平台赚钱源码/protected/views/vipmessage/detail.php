            ...
            <div class="public_db clearfix">
                ...
                <div class="cont prizes">
                    ...
                    <div class="news">
                        ...
                        <div class="details">
                            <div class="tit_1"><?php echo $vipmessage_info["title"]; ?></div>
                            <div class="time_date">
                                <span>发布时间：<?php echo $vipmessage_info["create_time"]; ?></span>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;来源：<?php echo "系统消息"; ?>
                                </span>
                            </div>
                            <div class="text">
                                <?php echo $vipmessage_info["content"]; ?>
                                <p class="log">、官方</p>
                                <p class="log"><?php echo $vipmessage_info["create_time"]; ?></p>
                            </div>
                            <div class="last_next clearfix">
                                <?php
                                $prevpost = $vipmessage_info->nextpost($pid, $mem["id"]);
                                $nextpost = $vipmessage_info->prevpost($pid, $mem["id"]);
                                ?>
                                <?php if (!empty($prevpost->id)) { ?>
                                    <a class="last" href="<?php echo SITE_URL . "vipmessage/detail/id/" . $prevpost->id . "/pid/" . $pid; ?>">上一篇：<?php echo $prevpost->title; ?></a>
                                <?php } ?>
                                <?php if (!empty($nextpost->id)) { ?>
                                    <a class="next" href="<?php echo SITE_URL . "vipmessage/detail/id/" . $nextpost->id . "/pid/" . $pid; ?>">下一篇：<?php echo $nextpost->title; ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
