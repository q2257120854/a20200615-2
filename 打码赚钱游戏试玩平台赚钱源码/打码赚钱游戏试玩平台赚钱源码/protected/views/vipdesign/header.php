...
<div class="top">
    <div class="big">
        <!--微博、微信关注   -->
        <ul class="ul_2">
            <li class="diy">莎莎源码 — 边玩边赚才是我们的终极目标</li>
			<!-- 
            <li class="gz">关注我们：</li>

            <li class="xinl sj" title="关注官方新浪微博">
                <a href="http://weibo.com/ihuanlezhuan" target="_blank"></a>
            </li>
            <li class="tenx sj" title="关注官方腾讯微博">
                <a href="http://t.qq.com/ihuanlezhuan" target="_blank"></a>
            </li>
            <li class="weix sj">
                <a href="javascript:"></a>
                <span class="erw"><img src="<?php echo IMG_URL ?>vip/img/wx_erw.png" /></span>
            </li>
			  -->
        </ul>
        <?php
        ...
        $ad_info = Ad::model()->findAllBySql("select img,url from {{ad}} where id =21 and open=0 ");
        ?>
        <!--登录后-->
        <ul class="ul_3">
            <li>
                ...
                <div class="neir">
                    <div class="d_1 clearfix">
                        <a href="<?php echo SITE_URL; ?>vipindex/show" class="tou" target="_blank">
                            <img src="<?php echo IMG_URL; ?>touxiang/<?php echo $memimg['img'] ?>" /></a>
                        <p class="account">
                        ...
                        <div class="neir_2">
                            <dl class="dl_2">
                                ...
                                foreach ($expadzm_info as $info) {
                                    ...
                                    ?>
                                    <dt>
                                    <?php if (empty($expad7["is_timely"])) { //is_timely数据返还类型 自动或者手动  ?>  
