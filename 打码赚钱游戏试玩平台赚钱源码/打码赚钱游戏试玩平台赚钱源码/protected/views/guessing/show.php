...
.wrw_nav {
 ...
 <div class="wrw_navBgr">
  ...
  <a href="<?php echo SITE_URL ?>guessing/show" class="selected">挖米啦</a>  
  <a href="<?php echo SITE_URL ?>expad/show" class="">任务吧</a>   
  <a href="<?php echo SITE_URL ?>gamecourse/show" class="">惠享游</a>   
 ...
 <iframe id="iframeId" style="width:102%;height:3000px;background-color:white;overflow:hidden;" frameborder="0" src="http://app.wamila.com/?action=index&wcid=6d393e05009e350d6f60863a6e15f395&userid=<?php echo $mem["id"]; ?>"></iframe>
					   </div>
