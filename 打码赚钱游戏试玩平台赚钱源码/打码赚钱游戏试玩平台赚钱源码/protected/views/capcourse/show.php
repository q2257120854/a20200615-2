...
.wrw_nav {
  ...
  <a href="<?php echo SITE_URL ?>capcourse/show" class="selected">新游盟</a>  
  </div>
</div> 
...
<iframe id="iframeId" style="width:102%;height:2000px;background-color:white;overflow:hidden;" frameborder="0" src="http://www.xinyoumeng.com/task/newhall?coop_id=11359&ukey=<?php echo $mem["id"]; ?>"></iframe>
					   </div>
