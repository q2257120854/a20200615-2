...
<!--底部二维码弹出框结束-->
<iframe src="<?php echo SITE_URL ?>index/login" class="regis" frameborder="0" ALLOWTRANSPARENCY="true"  id="regis"  style="display:none"></iframe> 
<!--头部-->
<div class="top">
    <div class="big">
        <!--微博、微信关注   -->
        ...
        <ul class="ul_2">
            ...
            <li class="weix sj">     <li class="weix sj">   
                <a href="javascript:"></a>
                <span class="erw"><img src="<?php echo IMG_URL; ?>img/wx_erw.png" /></span>
...
<div class="nav">
    <div class="big">
        ...
        <ul class="ul_1 clearfix">
            ...
            <!--            <li class="hover4">
                            <a href="http://009.90xqb.com/guessing/show"> 思思猜猜 </a>
                        </li>-->
            <li class="hover5">
                <a href="/captcha/show"> 打码平台 </a>
            </li>
            <li class="hover6">
                <a href="/expad/show"> 理财专区 </a>
            </li>
			<li class="hover4">
                <a href="/guessing/show""> 任务墙 </a>
            </li>
            <li class="hover7">
