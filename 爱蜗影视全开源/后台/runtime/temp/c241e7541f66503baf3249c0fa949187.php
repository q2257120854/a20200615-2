<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/www/wwwroot/awys.com/application/index/view/index/index.html";i:1573648448;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card-body layui-text">
                      <div class="layuimini-notice">
                            <div class="layuimini-notice-title">免费全新源码大全</div>
                        ...
                        <div class="layuimini-notice">
                            <div class="layuimini-notice-title">对接影视系统</div>
                            <div class="layuimini-notice-extra">2019-07-11 23:06</div>
                            <div class="layuimini-notice-content layui-hide">
                                本系统对接独家接口<br>
                                现有苹果cms接口<br>
                        ...
                        <div class="layuimini-notice">
                            <div class="layuimini-notice-title">全新系统</div>
                    ...
                    <div class="layui-card-body layui-text">
                        <table class="layui-table">
                            ...
                            <tr>
                                <td>当前版本</td>
                                <td>V<?php echo $banben; ?></td>
                            </tr>
                            <tr>
                                <td>作者QQ：</td>
                                <td>
                                  58197555
                                  <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=58197555&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:58197555:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
                              </td>
                            </tr>
                            <tr>
                                <td>问题反馈</td>
                                <td style="padding-bottom: 0;">
                                    <div class="layui-btn-container">
                                        <a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5WuaPuZ"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="千月对接苹果cms影视交" title="千月对接苹果cms影视交"></a>
