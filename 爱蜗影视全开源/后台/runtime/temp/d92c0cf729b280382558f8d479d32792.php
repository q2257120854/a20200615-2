<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/www/wwwroot/awys.com/application/index/view/banner/index.html";i:1563527852;}*/ ?>
			...
			<div class="panel-body">
                    <div class="btn-toolbar">
                       	<div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/1.html">
                                <button class="btn btn-info"> 首页顶部轮播图</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/2.html">
                                <button class="btn btn-info"> 首页顶部图标</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/3.html">
                                <button class="btn btn-info"> 首页电视剧轮播</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/4.html">
                                <button class="btn btn-info"> 首页电影轮播</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/5.html">
                                <button class="btn btn-info"> 首页动漫轮播</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/6.html">
                                <button class="btn btn-info"> 首页综艺轮播</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/7.html">
                                <button class="btn btn-info"> 个人中心权益广告</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/8.html">
                                <button class="btn btn-info"> 个人中心订单广告</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/12.html">
                                <button class="btn btn-info"> 聚合中心顶部轮播</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/13.html">
                                <button class="btn btn-info"> 播放页大图</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/14.html">
                                <button class="btn btn-info"> 播放页图标</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/21.html">
                                <button class="btn btn-info"> 福利轮播图</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/22.html">
                                <button class="btn btn-info"> APP代理专区轮播图</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/23.html">
                                <button class="btn btn-info"> 福利图标</button>
                            </a>
                        </div>
                                                  <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/25.html">
                                <button class="btn btn-info"> 福利底部广告</button>
                            </a>
                        </div>
                                                 <!-- <div class="btn-group focus-btn-group">
                            <a href="/index/banner/index/id/22.html">
                                <button class="btn btn-info"> 宝盒轮播图</button>
                            </a>
                        </div>-->
                                             </div>          
            <div class="panel-body">
  ...
  <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk"
                    ...
                    <table cellspacing="0" class="table table-small-font table-bordered table-striped">
                        ...
                        <tr>
							...
							<?php if($power == '0'): ?>
                            <th><?php echo getUsername($vo['uid']); ?></th>
                          	<?php endif; ?>
                            <th >
                                <?php echo $vo['linkurl']; ?>
                            </th>
