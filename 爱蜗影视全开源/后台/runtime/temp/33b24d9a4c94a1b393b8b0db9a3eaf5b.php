<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/awys.com/application/index/view/common/common.html";i:1573644292;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    function money(status,id){
        ...
        layer.prompt({title: '请输入充值点数', formType: 3}, function(pass, index) {
            if(!isNaN(pass))
            {
                ...
                window.location.href='http://awys.com/daili_pay/?id='+id+'&name=代理自助充点&fee='+pass;
                layer.close(index);
            }else{
