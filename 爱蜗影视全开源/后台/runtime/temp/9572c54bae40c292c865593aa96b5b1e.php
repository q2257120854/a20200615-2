<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/awys.com/application/index/view/banner/update.html";i:1558662798;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                         <option value="<?php echo $vo['id']; ?>"  <?php if($vo['id']==$c){echo 'selected';}else{echo ''; }?>  ><?php echo $vo['cname']; ?></option>
