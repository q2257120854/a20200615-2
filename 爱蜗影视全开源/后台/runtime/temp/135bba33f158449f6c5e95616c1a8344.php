<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/www/wwwroot/awys.com/application/index/view/user/clog.html";i:1544015816;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="panel-body">
                <div style="text-align: center">
                    <form class="validate" method="get" action="<?php echo url('user/clog'); ?>">
                        到期时间: <input class="form-control layui-input" type="date" name="start" >&nbsp;-&nbsp;<input class="form-control" type="date" name="end" >&nbsp;&nbsp;&nbsp;&nbsp;

                        <input class="form-control layui-input" placeholder="代理账户关键词" type="text" name="user">
                        <span class="layui-clear" style="margin-bottom: 10px;display: block"></span>
                        <input class="form-control layui-input" placeholder="用户账户关键词" type="text" name="vip" >
                        <button type="submit" class="layui-btn layui-btn-danger pull-left" style="height: 38px;margin-top: 7px;">搜索</button>
                    </form>
