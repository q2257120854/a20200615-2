<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/www/wwwroot/awys.com/application/index/view/vip/index.html";i:1559899580;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <!--标题-->
       ...
       <div class="panel-heading">
               ...
               <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 用户管理 （数量:<?php echo $count; ?>）
       		  </div>
    ...
    function ptime() {
        ...
        layer.open({
            ...
            '<select id="ctime" class="form-control">' +
				...
				' <option value="0.2"}>一个月:0.2元</option>' +
				' <option value="0.3"}>三个月:0.3元</option>' +
				' <option value="0.4"}>六个月:0.4元</option>' +              
				' <option value="0.5"}>一年:0.5元</option>' +
				' <option value="0.6"}>永久:0.6元</option>' +
            ' </select>' +
            ' </div>' +
