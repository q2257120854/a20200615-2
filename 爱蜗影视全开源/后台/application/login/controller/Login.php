...
db('cxjl')->where('uid',$username)->where('title',$spname)->update(['time' => $time]);
  ...
  public function logo() 
    ...
    //    $arr['weichat'] = $dai3['weichat']; 
		...
		$arr['url5'] = $dai111['url7']?$dai111['url5']:"";
		$arr['url4'] = $dai111['url7']?$dai111['url4']:"";
		$arr['url3'] = $dai111['url7']?$dai111['url3']:"";
		$arr['url2'] = $dai111['url7']?$dai111['url2']:"";
		$arr['url1'] = $dai111['url7']?$dai111['url1']:"";
  ...
  public function paymoney(){
	    ...
	    if($so['money']<$data['money']){
	    return json(['code'=>0,'msg'=>'您的余额不足，请充值后购买！']);
	    }
	    $user=db('user')->where('id',$data['uid'])->find();
	    
	    if($data['leix']==1){
	      db('user')->where('id',$data['uid'])->update(['money'=>$user['money']-$data['money']]);
  ...
  public function banben() 
	{
      $data=input();
       $soi=db('shezi')->where('id',1)->find();
		...
		return json(['banben'=>advert('6'),'url'=>advert('4'),'url1'=>advert('8'),'url2'=>advert('9'),'url3'=>advert('10'),'url4'=>advert('11'),'url5'=>advert('12'),'url6'=>advert('13'),'url7'=>advert('14'),'url8'=>advert('15'),'advert' => advert('7'),'advert3' => advert('21'),'advert4' => advert('20')]);
	}
  //通信
 ...
 public function dayin()
  ...
  return json(['code' => '1','msg'=>$arr]);
	...
	public function yaoqingma(){
		...
		if($user['parentid']!==1){
			return json(['code' => '1','msg'=>'已经绑定邀请码'.$user['parentid']]);
		}
		$user_info=db('user')->where('share_ma',$data['parentid'])->find();
		if(!$user_info){
			return json(['code' => '1','msg'=>'邀请码不存在']);
		}
		db('user')->where('id',$data['id'])->update(['parentid'=>$user_info['id']]);
		if ($data) 
		{
			return json(['code'=>0,'msg'=>'绑定成功!请返回']);
		}
		else 
		{
