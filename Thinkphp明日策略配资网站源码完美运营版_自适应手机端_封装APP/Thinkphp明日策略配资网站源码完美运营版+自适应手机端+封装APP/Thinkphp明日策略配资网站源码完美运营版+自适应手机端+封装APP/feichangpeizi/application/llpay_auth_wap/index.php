        ...
        <form name=llpayment action=llpayapi.php method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="no_order" value="<?php echo date('YmdHis');  ?>" />
...
：</dt>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="card_no" value="6228480661544993412"/>
                        <span>
</span>
                    </dd>
                       <dt>姓名：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="acct_name" value="盛光"/>
                        <span>
</span>
                    </dd>
                      <dt>身份证号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="id_no" value="420922198811053854"/>
                        <span>
</span>
                    </dd>
