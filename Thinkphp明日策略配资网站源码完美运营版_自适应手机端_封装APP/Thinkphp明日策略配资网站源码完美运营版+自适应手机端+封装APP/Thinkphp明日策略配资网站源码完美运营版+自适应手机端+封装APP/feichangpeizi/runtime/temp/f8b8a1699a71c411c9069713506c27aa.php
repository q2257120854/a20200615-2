<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/feichangpeizi/application/index/view/ucenter/mobile/freetrialSell.html";i:1540755618;}*/ ?>
<!doctype html>
<html>
	...
	<body class="sell_body">
		...
		<div class="mui-content">
			...
			<div class="bg_fff mui-segmented-control mui-segmented-control-inverted">
				...
				<a class="sell_a mui-control-item mui-active" href="/freetrialSell.html">点卖<span id="shareNum"><?php echo $count; ?></span></a>
			...
			<div id="item1" class="mui-control-content mui-active">
				    ...
				    <li class="mui-table-view-cell mui-collapse">
				        <a class="mui-navigate-right" href="#">
				        	<div class="share_l mui-pull-left">
				        		...
				        		<p>金额：<span class="moneyNum" style="margin-right: 5px;"><?php echo round($vo['dealAmount'],2); ?>万</span>
				        ...
				        <div class="cont mui-row">
				        	...
				        	<div class="num_info mui-col-xs-3 mui-col-sm-3" <?php if($list2[$i-1][profitAmount] < 0): ?> style="color:#19B777" <?php else: ?> style="color:#e60012" <?php endif; ?>>
				...
				<p class="mtop_25 mui-text-center">当前持仓所需递延费为<span class="color_red">0</span> 元（周末及节假日免费）</br>持仓盈利总计：<span class="color_red"><?php echo $profitSum; ?></span> 元</p>
