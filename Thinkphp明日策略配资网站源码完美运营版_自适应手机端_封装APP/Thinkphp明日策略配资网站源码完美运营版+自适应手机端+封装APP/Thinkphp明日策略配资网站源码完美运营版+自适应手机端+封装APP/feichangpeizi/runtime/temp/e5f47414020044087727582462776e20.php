<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/feichangpeizi/application/index/view/ucenter/mobile/index.html";i:1540755746;}*/ ?>
<!doctype html>
<html>
		...
		<div class="mui-content">
			<div class="">
				...
				<div class="mui-segmented-control mui-segmented-control-inverted">
					<a class="mui-control-item <?php if($_GET['flow'] == ''): ?> mui-active <?php endif; ?>" data-href="/ucenter/index.html?recent=<?php echo $_GET['recent']; ?>" >全部</a>
					<a class="mui-control-item <?php if($_GET['flow'] == '1'): ?> mui-active <?php endif; ?>" data-href="/ucenter/index.html?flow=1&recent=<?php echo $_GET['recent']; ?>" >收入</a>
					<a class="mui-control-item <?php if($_GET['flow'] == '2'): ?> mui-active <?php endif; ?>" data-href="/ucenter/index.html?flow=2&recent=<?php echo $_GET['recent']; ?>" >支出</a>
				</div>
				<!--内容-->
				<div class="">
					<!--item1-收入和支出-->
