<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/wwwroot/feichangpeizi/application/index/view/index/help.html";i:1540177711;s:65:"/www/wwwroot/feichangpeizi/application/index/view/public/top.html";i:1539839495;s:68:"/www/wwwroot/feichangpeizi/application/index/view/public/footer.html";i:1540301736;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="help_body helpcenter logged-in">
...
<link rel="stylesheet" type="text/css" href="/public/static/home/css/help.css"/>
...
<section class="container">
    <div class="question ">
        ...
        <div class="list-area">
            <div class="area ashare">
                <p>点买A股 <span class="select_help"></span></p>
                <ul class="clearfix hide" data-type="ashare"></ul>
            </div>
            <div class="area astockbuy">
                <p>点买问题<span class="select_help"></span></p>
                <ul class="clearfix hide" data-type="astockbuy"></ul>
            </div>
            <div class="area billing">
                <p>清算问题<span class="select_help"></span></p>
                <ul class="clearfix hide" data-type="billing"></ul>
            </div>
            <div class="area recharge">
                <p>充值问题<span class="select_help"></span></p>
                <ul class="clearfix hide" data-type="recharge"></ul>
            </div>
        </div>
    </div>
    <div class="answer hide">
        <div class="main-area">
            <p class="q-row">点买点卖时间</p>
            <p class="a-row">交易日点买点卖时间为：9:00-11:30 13:00-14:55。</p>
        </div>
    </div>
</section>
</div>
    ...
    <div class="popup-body group">
        <div class="field-row group" style="text-align:center">
            <ol class="popup-note">
                ...
                <li style="text-align:left;">如遇到问题，请联系客服 QQ <label id="m_basic_mobile">806247358</label></li>
            </ol>
