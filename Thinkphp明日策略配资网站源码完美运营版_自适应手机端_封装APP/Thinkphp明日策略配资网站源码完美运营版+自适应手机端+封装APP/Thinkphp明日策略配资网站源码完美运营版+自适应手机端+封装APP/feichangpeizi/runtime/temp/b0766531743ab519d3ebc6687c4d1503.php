<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/feichangpeizi/application/index/view/ucenter/mobile/sell.html";i:1540899945;}*/ ?>
<!doctype html>
<html>
	...
	<body class="sell_body">
				    ...
				    <li class="mui-table-view-cell mui-collapse">
				        ...
				        <div class="cont mui-row">
				        	...
				        	<div class="num_info color_red mui-text-right mui-col-xs-3 mui-col-sm-3">
				        		...
				        		<button id="<?php echo $vo['id']; ?>" index="<?php echo $i; ?>" v="<?php echo $vo['stockCode']; ?>" class="btnSell pay_btn font12" href="javascript:void(0);">注资</button>	
		...
		<script type="text/javascript">
         ...
         $('.sell_btn').on('tap',function(e){
          ...
          //pay_btn点买按钮按下时
         $('.pay_btn').on('tap',function(e){
           //拿到当前按钮的id
         	var stockCode = $(this).attr('v');
         	window.location.href = "/buy/stockCode/"+stockCode;
         });
            //分页高亮
...
//  console.log(curTime);
   ...
   // 如果不在交易时间，不能点买
   if(!isTradingTime() ){
     $('.sell_btn').attr('disabled',true).css({'background':'#767679'});
     $('.pay_btn').attr('disabled',true).css({'background':'#767679'});
     mui.toast('点卖时间9:30-11:30, 13:00-14:58')
   }
   </script>
	</body>
