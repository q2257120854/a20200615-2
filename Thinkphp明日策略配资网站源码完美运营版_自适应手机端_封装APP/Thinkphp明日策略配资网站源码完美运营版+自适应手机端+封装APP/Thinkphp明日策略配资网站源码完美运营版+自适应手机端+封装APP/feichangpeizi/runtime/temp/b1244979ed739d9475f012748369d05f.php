<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/feichangpeizi/application/index/view/ucenter/mobile/history.html";i:1540755664;}*/ ?>
<!doctype html>
<html>
	...
	<body class="history_body sell_body">
		...
		<div class="mui-content">
			...
			<div class="bg_fff mui-segmented-control mui-segmented-control-inverted">
				...
				<a class="mui-control-item mui-active" href="/history.html">结算</a>
			</div>
			<!--内容-->
