<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/www/wwwroot/feichangpeizi/application/index/view/ucenter/sell.html";i:1540901783;s:65:"/www/wwwroot/feichangpeizi/application/index/view/public/top.html";i:1539839495;s:68:"/www/wwwroot/feichangpeizi/application/index/view/public/footer.html";i:1540301736;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <section class="play-area">
        <nav>
            <ul class="clearfix">
                ...
                <li class="active"><a href="/sell.html"><em>02 </em>| 点卖区</a></li>
        ...
        <section>
            <center>
                ...
                &nbsp;<label style="font-size:18px">(周末及节假日免费)</label>，持仓盈利总计：<span id="totalProfit" style="font-size: 22px;"> <?php echo (isset($profitSum) && ($profitSum !== '')?$profitSum:0); ?> </span>元<br/>
              <label id="info" style="color:#fff ;font-size:16px;font-weight:300"></label>
            </center>
...
//  console.log(curTime);
   ...
   // 如果不在交易时间，不能点买
   if(!isTradingTime() ){
     $('.btnSell').attr('disabled',true).css({'background':'#767679'});
     $('#info').attr('disabled',true).css({'background':'#767679'}).html('点卖时间9:30-11:30, 13:00-14:58');
   }
   </script>