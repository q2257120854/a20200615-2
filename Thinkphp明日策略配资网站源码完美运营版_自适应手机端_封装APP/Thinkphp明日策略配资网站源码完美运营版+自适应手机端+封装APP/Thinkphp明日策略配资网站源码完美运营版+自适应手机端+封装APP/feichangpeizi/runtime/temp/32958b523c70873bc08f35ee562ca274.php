<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/feichangpeizi/application/index/view/index/mobile/buy.html";i:1540838586;}*/ ?>
<!doctype html>
<html>
	...
	<body class="buy_body">
		...
		<div class="mui-content">
			...
			<div class="bg_fff mui-segmented-control mui-segmented-control-inverted">
				<a class="mui-control-item mui-active" href="/#">点买</a>
				<a class="sell_a mui-control-item" href="/sell.html">点卖</a>
			...
			<div id="item2" class="mui-control-content mui-active bg_fff">
				...
				<ul class="choseBox2" style="margin: 0;">
					<li class="mui-row">
						...
						<div class="chose_item mui-col-xs-9 mui-col-sm-9">
							<a class="bz_text" href="javascript:void(0);" style="color: black;">100%</a>
						</div>
      ...
      <script type="text/javascript">
          ...
          if (url.indexOf("/stockCode/") != -1) {
          var str = url.substr(url.indexOf("/stockCode/")+11);
          $('#searchTxt1').val(str);
