...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=llpayment action="/index/lianlianpay/doPay" method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                      <dt>商户用户唯一编号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="user_id" value="<?php echo @date('YmdHis', time()).'R'.rand(10000, 99999); ?>" />
                        <span>必填</span>
                    </dd>
                     <dt>商户业务类型：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="no_order" value="<?php echo @date('YmdHis', time());  ?>"/>
                        <span>商户订单系统中唯一订单号，必填</span>
                    </dd>
                      <dt>交易金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="money_order" value="0.03"/>
                        <span>必填</span>
                    </dd>
                    <dt>商品名称：</dt>
                    <dd>
