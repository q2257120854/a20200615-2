            ...
            (t = [{
                ...
                value: function (e) {
                    "init" === e ? (this._lPage.addClass("side-trans-enabled"),
                        this._uiHandleSidebars()) : this._lPage.hasClass("side-scroll") ? (this._lSidebar.length > 0 && !this._lSidebarScroll && (this._lSidebarScroll = new SimpleBar(this._lSidebar[0]),
                ...
                key: "_uiApiBlocks",
                value: function () {
                    var e, a, t, o = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init",
                        r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], l = this,
                        i = "si si-size-fullscreen", s = "si si-size-actual", d = "si si-arrow-up",
                        c = "si si-arrow-down", u = {
                            init: function () {
                            ...
                            content_toggle: function () {
                                ...
                                t.length && (e.hasClass("block-mode-hidden") ? jQuery("i", t).removeClass(d).addClass(c) : jQuery("i", t).removeClass(c).addClass(d))
                            },
