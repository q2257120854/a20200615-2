...
安全中心
	...
	<ul class="list-group">
<li class="list-group-item"><span class="btn-sm btn-success">正常</span>&nbsp;暂未发现网站安全问题</li>	</ul>
</div>
...
检测更新
	...
	<ul class="list-group text-dark" id="checkupdate"><li class="list-group-item"><font color="green">您使用的已是最新版本！</font><br>当前版本：V6.1.5 (Build 2036)</li><li class="list-group-item"><a href="http://cccer.cn/" target="_blank" rel="noreferrer" style="font-weight:bold">[推广]可乐网络中心！</a></li></ul>
</div>
    </div>
</div>
<script>
