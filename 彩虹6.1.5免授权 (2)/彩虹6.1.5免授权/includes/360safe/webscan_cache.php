...
$webscan_white_url = array('set.php' => 'mod=site_n', '/set.php' => 'mod=gonggao_n', 'shopedit.php' => 'my=edit_submit', '/shopedit.php' => 'my=add_submit', 'message.php' => 'my=add_submit', '/message.php' => 'my=edit_submit', '/uset.php' => 'mod=site_n', 'Article.php' => 'act=save');
?>