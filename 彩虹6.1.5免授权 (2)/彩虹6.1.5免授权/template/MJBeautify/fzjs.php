...
<header style="padding-right:12px;">
    分站介绍<a style="left:0" href="#" onclick="javascript:history.back(-1);"><i class="fa fa-reply-all"
...
<div class="body-box" style="max-width: 800px;">
    ...
    <div class="header-img-box">
        <img src="http://wx1.sinaimg.cn/mw690/0060lm7Tly1fxnm4wme9cj30jg063wfu.jpg"
             style="width:100%;border-bottom:#ddd solid 1px;">
        <div class="tw2 text">
            穷人不学穷根不断，富人不学富不长久
        </div>
    </div>
    ...
    <div class="text-kuang" style="line-height:20px;">
        ...
        <center>
            <a class="btn btn-info btn-sm tw1" style="margin-right:30%"
               href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
               target="_blank">咨询客服</a><a class="btn btn-info btn-sm tw1" href="./user/regsite.php">搭建分站</a>
        </center>
        <hr>
        ...
        <div style="font-size:13px;">
            ...
            <center>
                <font class="rdu-5x"
                      style="border:#ff8000 solid 1px;padding:5px 30px;display:inline-block;margin:5px 0;color:#f00;">提成
                    = 售价 - 成本价</font>
            </center>
            <div style="text-indent:2em;">
