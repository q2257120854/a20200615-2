    ...
    <div class="hide-gdt">
        <div style="width:200px;height:100%;background: rgba(59, 51, 51, 0.2);">
            ...
            <div class="zzqq-text">站长QQ：
                <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
                   style="color:#0080ff;" target="_blank">
            ...
            <div class="notice-imgbox">
                <a data-toggle="modal" href="#kftc">
                    <img src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $conf['kfqq'] ?>&spec=100" alt="Avatar"
                         class="fa-spin" style="width:39px;height:39px;border:1px solid #5cadad;border-radius:50%;">
                    <div class="tb">
            ...
            <?php if (!empty($conf['appurl']) && !$is_fenzhan) { ?>
                <li><a href="<?php echo $conf['appurl'] ?>">
                        <span class="glyphicon glyphicon-cloud-download"
                              style="font-size:12px; margin-right:3px;"></span>APP下载</a>
                </li>
            <?php } else { ?>
                <li><a href="./user/">
    ...
    <i class="fa fa-warning"></i> 下单必看</a></span>
                ...
                <ul class="nav nav-tabs zzxd-naw" data-toggle="tabs" style="background:#f3f3f3;">
                    <li class="active"><a href="#onlinebuy" data-toggle="tab" style="border:none;">
                            <div><span class="fa fa-shopping-cart fa-fw"></span></div>
                            下 单</a>
                    </li>
                    ...
                    <li><a href="#zq" data-toggle="tab" style="border:none;color:#f00;">
                            <div><i class="fa fa-usd fa-fw fa-spin"></i></div>
                            赚 钱</a>
                    </li>
                    <li align="center" <?php if ($conf['gift_open'] == 0){ ?>class="hide"<?php } ?>>
                        <a href="#gift" data-toggle="tab" style="border:none;">
                            <div class="zzxd-naw-circular"><i class="fa fa-gift fa-fw"></i></div>
                            抽 奖</a>
                    </li>
                    <li style="width: 20%;" align="center"
                        <?php if ($conf['iskami'] == 0 || $conf['fenzhan_buy'] == 1 && $conf['gift_open'] == 1){ ?>class="hide"<?php } ?>>
                        <a href="#cardbuy" data-toggle="tab" style="border:none;">
                            <div><i class="glyphicon glyphicon-th"></i></div>
                            卡 密</a>
                    </li>
                    <li><a href="#more" data-toggle="tab" style="border:none;">
                            <div><i class="fa fa-th-large fa-fw" style="font-size:13px; margin-left:1px;"></i></div>
                            更 多</a>
                    </li>
                </ul>
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="tab-pane fade in" id="query" style="padding:8px 0;">
                            <div class="qqkf-card-title">
                                ...
                                <img class="right" src="./assets/beautify/img/gg-pmd.jpg"
                                     style="width:70px;height:10px;margin:2px 10px;">
                            </div>
                            <div class="qqkf-card" style="margin-bottom:8px;">
                                ...
                                <div class="right-box tw1">
                                    <div>
                                        <b style="color:#f00">有啥问题要联系客服哦</b><img class="right"
                                                                                 src="./assets/beautify/img/gg-rz.jpg"
                                                                                 style="width:30px;height:15px;">
                                    </div>
                                    <b>QQ</b>：<a data-toggle="modal" href="#kftc"
                                                 style="color:#0080ff"><?php echo $conf['kfqq'] ?></a>
                                </div>
                            </div>
                        ...
                        <!--免费拉圈-->
                        <div class="modal fade" align="left" id="lqq" tabindex="-1" role="dialog"
                        ...
                        <div class="tab-pane fade in" id="gift">
                            <div class="panel-body text-center">
                                <div id="roll">
                                    <img style="width:28px;height:28px;margin:-3px 5px 0 0;display:inline-block;"
                                         src="./assets/beautify/img/gg-ax.jpg">点击下方按钮开始抽奖
                                </div>
                                <hr>
                                <p>
                        ...
                        <div class="tab-pane fade fade-right" id="more">
                            <div style="margin:8px -15px -17px -15px;">
                                <ul id="more-naw">
                                    <li id="kami-box"
                                        class="<?php if ($conf['iskami'] == 0 || $conf['fenzhan_buy'] == 0 || $conf['gift_open'] == 0) { ?> hide<?php } ?>">
                                        <a href="#cardbuy" data-toggle="tab" style="background:#ee5757;">
                                            <div class="more-title-text"><i class="fa fa-credit-card"></i></div>
                                            卡密下单</a>
                                    </li>
                                    <li class=" <?php if (empty($conf['invite_tid'])) { ?> hide<?php } ?>">
                                        <a href="./?mod=invite" target="_blank" style="background:#f164f1;">
                                            <div class="more-title-text"><i class="glyphicon glyphicon-hand-right"></i>
                                            </div>
                                            免费领赞</a>
                                    </li>
                                    <li>
                                        <a href="./user" target="_blank" style="background:#51b1ee;">
                                            <div class="more-title-text"><i class="glyphicon glyphicon-user"></i></div>
                                            分站登入</a>
                                    </li>
                                    <li>
                                        <a href="./user" target="_blank" style="background:#51b1ee;">
                                            <div class="more-title-text"><i class="fa fa-shield"></i></div>
                                            免费加盟</a>
                                    </li>
                                    <li class="<?php if (empty($conf['daiguaurl'])) { ?> hide<?php } ?>">
                                        <a href="./?mod=daigua" style="background:#79eded;">
                                            <div class="more-title-text"><i class="fa fa-qq"></i></div>
                                            QQ等级代挂</a>
                                    </li>
                                    <li class="<?php if (empty($conf['appurl'])) { ?> hide<?php } ?>">
                                        <a href="<?php echo $conf['appurl']; ?>" target="_blank"
                                           style="background:#f164f1;">
                                            <div class="more-title-text"><i class="fa fa-paper-plane-o"></i></div>
                                            APP下载</a>
                                    </li>
                                </ul>
                            </div>
    ...
    <i class="fa fa-shopping-cart"></i> 返回下单</a></span>
                ...
                <div class="panel-group" id="accordion">
                    <div style="border:none;padding:10px 0;">
                        <a class="xl-button" data-toggle="collapse" data-parent="#accordion"
                           href="#collapse1">平台下单温馨提示</a>
                        ...
                        <div id="collapse3" class="panel-collapse collapse xlbox">
                            1、下单前务必填写正确的QQ号及密码等！若填写错误_后果自负哦 ~<br>2.复制你全名k歌里面的需要刷的歌曲链接<br>2、自身带有本业务的请不要下单（如：你本来有会员，就不要下单会员或超会了）但可以下单其他永久钻（如黄钻）或者等官方钻到期了在下单。<br>3、永久钻是“理论永久”_
                            是有可能会掉的！若运气好是几个与或者大半年及几年都不会掉。但我们这都是有质保天数的！掉单了按天数退款_ 不会让你亏的。
                        </div>
                        <a class="xl-button" data-toggle="collapse" data-parent="#accordion"
                           href="#collapse4">永久钻下单温馨提示</a>
                        <div id="collapse4" class="panel-collapse collapse xlbox">
                            1、下单前务必填写正确的QQ号及密码等！若填写错误_后果自负哦 ~<br>2.复制你全名k歌里面的需要刷的歌曲链接<br>2、自身带有本业务的请不要下单（如：你本来有会员，就不要下单会员或超会了）但可以下单其他永久钻（如黄钻）或者等官方钻到期了在下单。<br>3、永久钻是“理论永久”_
                            是有可能会掉的！若运气好是几个与或者大半年及几年都不会掉。但我们这都是有质保天数的！掉单了按天数退款_ 不会让你亏的。
                        </div>
                        <a class="xl-button" data-toggle="collapse" data-parent="#accordion" href="#collapse5">KF代刷下单方法讲解</a>
                        <div id="collapse5" class="panel-collapse collapse xlbox">
                            1.需要填写用户ID和作品ID，比如<font color="#ff0000">http://www.kuaishou.com/i/photo/lwx?userId= <font
                                        color="green">294200023</font> &photoId= <font
                                        color="green">1071823418</font></font> (分享作品就可以看到“复制链接”了)<br>2.用户ID就是 <font
                                    color="green">294200023</font> 作品ID就是 <font color="green">1071823418</font>
    ...
    <div class="main-panel">
        <div class="title">
            ...
            <div class="right" style="line-height:50px;letter-spacing:2px;">
                ...
                <i><font color="#FF0000">我</font><font color="#DF0020">们</font><font color="#BF0040">一</font><font
                            color="#9F0060">直</font><font color="#7F0080">用</font><font color="#5F00A0"><span
                                class="glyphicon glyphicon glyphicon-heart-empty"
                                style="margin-left:4px;"></span></font><font color="#3F00C0">在</font><font
                            color="#1F00E0">做</div>
            </i></font>
        </div>
        <table class="zdxx-form">
            ...
            <tr>
                <td>
                    <div class="left-box"><i class="fa fa-shopping-cart fa-fw"></i></div>
                    <div class="right-box">
                ...
                <td style="border-right:none">
                    <div class="left-box"><i class="fa fa-firefox fa-fw" style="font-size:28px; "></i></div>
                    <div class="right-box">
                        <div class="text">旗下分站</div>
                        9999+ 个
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="left-box"><i class="fa fa-usd fa-fw"></i></div>
                    <div class="right-box">
                        <div class="text">累计交易</div>
                        9999+ 元
                    </div>
                </td>
                <td style="border-right:none">
                    <div class="left-box"><i class="fa fa-anchor fa-fw" style="font-size:28px; "></i></div>
                    <div class="right-box">
                        <div class="text">分站提成</div>
                        9999+ 元
                    </div>
                </td>
            </tr>
        ...
        <a href="./user/regsite.php" class="zdxx-lj-li"><font color="#ff00ff">搭建分站仅需<?php echo $conf["fenzhan_price"] ?>
                一<?php echo $conf["fenzhan_price2"] ?>元</font>
...
<div class="modal fade" align="left" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog popup-bj" style="margin-right:2px;margin-left:12px;max-width:520px;">
        ...
        <div class="modal-body"
             style="padding:10px;color:#272727;color:#272727;font-size:13px;"><?php echo $conf['modal'] ?></div>
...
<div class="modal fade" align="left" id="anounce" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog popup-bj" style="margin-right:2px;margin-left:12px;max-width:520px;">
        ...
        <div class="modal-body"
             style="padding:10px;color:#272727;color:#272727;font-size:13px;"><?php echo $conf['anounce'] ?></div>
        <div class="modal-footer" style="border-top-color:#399;">
            <button type="button" class="btn btn-default" data-dismiss="modal">知道啦</button>
        </div>
    </div>
...
<!-- 推介商品 -->
<div class="modal fade" align="left" id="tjsp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog popup-bj" style="margin-right:2px;margin-left:12px;max-width:520px;">
        <div class="popup-title">
...
<!-- 客服弹窗 -->
<div class="modal fade" align="left" id="kftc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog popup-bj" style="margin-right:2px;margin-left:12px;max-width:520px;">
        <div class="popup-title">
            <div class="popup-title-text">
        ...
        <div class="modal-body" style="padding:0;color:#272727;font-size:13px;">
            ...
            <div class="qqkf-card-two" style="margin:12px;">
                ...
                <div class="right-box tw1">
                    ...
                    <b>QQ</b>：<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
                                 target="_blank" style="color:#0080ff;"><?php echo $conf['kfqq'] ?>
                    </a>
                    <div style="padding:4px 0;font-size:11px;color:#ff8000;">
                        一直用心在做 ---
                        <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
                           target="_blank" class="btn btn-info btn-sm rdu-5x" style="padding:2px 6px; margin-left:2%;">联系客服</a>
                    </div>
                </div>
            </div>
