...
<header>
    <div class="logo"><img src="<?php echo $logo; ?>" style="height:40px; width:40px;" alt=""></div>
...
<div class="body-box" style="max-width: 800px;">
    ...
    <div class="panel-shadow panel-bor-top rdu-5x" style="position:relative;z-index:-2;">
        <div style="width:100px;background:#fff;margin:0 auto;text-align:center;">
            <img src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $conf['kfqq'] ?>&spec=100"
                 style="width:70px; height:70px;border-radius:50%;margin-top:10px;" alt="">
        </div>
        <div class="fgx"></div>
        <div class="pd-text cnt" style="border:none">
            <font color="#f00"><b>主 站 长</b></font><img src="./assets/beautify/img/gg-rz.jpg"
                                                       style="height:15px;margin:-2px 0 0 5px;">
        </div>
        <ul class="two-df-naw">
            <li style="border-right:#ddd solid 1px;text-align:left;"><font color="#f00">职业</font>：程序猿（专业）</li>
            <li style="text-align:left;"><font color="#f00">站长QQ</font>：<font
                        color="#0080ff"><?php echo $conf['kfqq'] ?></font></li>
        </ul>
    ...
    <div class="panel-shadow panel-bor-top rdu-5x">
        <div style="text-align:center;padding:12px 0;"><img src="<?php echo $logo ?>" style="width:70px;height:70px;"
                                                            alt=""></div>
        <div class="cnt title-bj">
            <div class="title tw2"><b><?php echo $conf['sitename'] ?></b></div>
        </div>
        <div class="sjx"></div>
        ...
        <div class="pd-text">
            <div class="cnt"
                 style="margin:5px 17% 10px 17%;padding-bottom:10px;border-bottom:#ff8000 solid 2px;color:#f00;">
                本站于：<?php echo $conf['build'] ?> 正式成立
            </div>
            <div>我们是全网最专业的代刷系统，商品齐全、货源稳定、价格低廉、售后保障。拥有丰富的人脉和资源，我们专注于优质商品，实时掌握代刷市场的动态。</div>
            <div style="padding:8px 0; text-align:center;">
                <a href="./user/reg.php">
                    <img style="width:80px; margin-right:20px;" src="./assets/beautify/img/gg-hyff.jpg" alt="">
                    <img style="width:80px; margin-right:20px;" src="./assets/beautify/img/gg-cyjm.jpg" alt="">
                    <img style="width:80px; " src="./assets/beautify/img/gg-gtzf.jpg" alt=""></a>
            </div>
            <div>
            ...
            <div style="border-top:#ff8000 dashed 1px;padding:10px 17% 5px 17%;margin-top:10px;">
                ...
                <a class="btn btn-info btn-sm" href="./user/regsite.php" style="float:right;"><i
                            class="glyphicon glyphicon-fire"></i> 加盟分站</a>
            </div>
        </div>
        <ul class="three-df-naw">
            ...
            <li>
                <div>交易总额</div>
                <span id="count_money"></span> 元
            </li>
            <li>
                <div>旗下分站</div>
                <span id="count_site"></span> 个
            </li>
        </ul>
    </div>
...
<footer class="tw1"
        style="line-height:40px;width:100%;display:block;text-align:center;background: rgba(255, 255, 255, 0.7);border-top:#bbb solid 1px;color:#333;font-size:13px;">
