                    ...
                    <i class="fa fa-fw fa-angle-down text-active"></i>
                        ...
                        <?php if (!empty($conf['appurl'])) { ?>
                            <li><a target="_blank" href="<?php echo $conf['appurl']; ?>"><i
                                            ...
                                            class="sidebar-nav-mini-hide">APP下载</span></a></li>
                        <?php } ?>
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="panel panel-info" draggable="true">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                什么是<?php echo $conf['sitename'] ?>的分站，主站？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                分站就是和我们一样的网站，拥有和我们一样的大部分功能。
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                如何搭建？多少钱？能使用多长时间？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                付款给我们客服，一条龙搭建，目前普通分站6.66元，高级分站40元，主站100元，永久使用时间。（授权100永久使用）
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span> 能赚钱吗？搭建后如何赚钱？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                保证回本赚钱！客户访问你的分站并下单，你就有提成，你也可以直接以代理价格帮别人下单。
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                赚到的钱在哪里？我如何得到？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                分站后台有完整的消费信息和余额信息，您可以提现到支付宝微信或者QQ钱包。
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                需要我自己供货吗？哪来货源？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                所有商品全部对接主站，无需您当心货源，所有订单我们来处理。
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                可以自己上架商品吗？可以修改售价吗？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                亲，所有分站暂时都不支持上架商品和修改价格，接下来的更新会添加。
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                这个和卡盟一样吗？有什么区别？
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-success btn-xs">答</span>
                                完全不同，利润更高，货源更精，无需注册,无需预存，在线支付，卡密下单，更直接。
                            </div>
                            <div class="list-group-item reed"><span class="btn btn-danger btn-xs">问</span>
                                那么多代刷有分站，主站，为什么选择<?php echo $conf['sitename'] ?>搭建？
                            </div>
                            <div class="list-group-item reed"><span
                                        class="btn btn-success btn-xs">答</span> <?php echo $conf['sitename'] ?>
                                从事网赚两年多，拥有丰富的人脉和资源，我们的货源全部精挑细选全网性价比最高的，实时掌握代刷市场的动态，加入我们，只要你坚持，你不用担心不赚钱，不用担心货源不好，更不用担心我们跑路，我们不敢保证你月入几千上万，在网上赚个零花钱绝对没问题！
                            </div>
                        </div>
                    </div>
                </div>
