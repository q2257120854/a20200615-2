                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><font color="#fff"><i
                                ...
                                class="pull-right"><a data-toggle="tab" href="#demo-tabs-box-2" aria-expanded="true"
                                                      class="btn btn-warning btn-rounded"><i class="fa fa-warning"></i> 注意</a></span>
                    </h3>
                </div>
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#onlinebuy" data-toggle="tab"><i class="fa fa-shopping-cart"></i> 下单</a>
                    </li>
                    <li <?php if ($conf['iskami'] == 0){ ?>style="display:none;"<?php } ?>><a href="#cardbuy"
                                                                                              data-toggle="tab"><i
                    ...
                    <li <?php if ($conf['fenzhan_buy'] == 0){ ?>class="hide"<?php } ?>><a href="./user/regsite.php"
                                                                                          style="color:red">开通分站</a>
                    </li>
                    <?php if ($islogin2 == 1) { ?>
                        <li <?php if ($conf['fenzhan_buy'] == 0){ ?>class="hide"<?php } ?>><a href="./user/">用户中心</a>
                        </li>
                    <?php } else { ?>
                        <li <?php if ($conf['fenzhan_buy'] == 0){ ?>class="hide"<?php } ?>><a href="./user/login.php">后台登录</a>
                        </li>
                    <?php } ?>
                </ul>
                <div class="modal-body">
