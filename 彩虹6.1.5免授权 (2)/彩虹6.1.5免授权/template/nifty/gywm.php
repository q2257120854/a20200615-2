                ...
                <div class="row">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title">一直用 <font color="#FFFFFF"><i class="fa fa-heart-o fa-lg"></i></font>
                                在做
                                <div class="hide-fixed pull-right pad-rgt"><em>建立于：<?php echo $conf['build'] ?></em>
                                </div>
                            </h3>
                        </div>
                        <div class="panel-body">
                            专业的代刷自助下单平台，优质的售后服务，致力于最专业的代刷平台！
                            <hr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="km_show_frame" style="display:none;">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon" id="inputname">下单帐号</div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="qq" id="qq3" value="" class="form-control"
                               placeholder="输入下单的帐号（留空根据浏览器缓存显示）" required/>
                    </div>
