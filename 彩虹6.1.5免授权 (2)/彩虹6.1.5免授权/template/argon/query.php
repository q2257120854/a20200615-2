                        ...
                        <div class="row">
                            <div class="col-lg-4 col-12 shuaibi-but10">
                                <div class="panel-body">
                                    <div class="alert alert-success px-0"
                                         role="alert"><?php echo $conf['gg_search'] ?></div>
                                </div>
                            </div>
                            <div class="col-lg-8 col-12">
                                    ...
                                    <div class="input-group focused text-left">
                                        <div class="input-group-btn">
                                            <select class="form-control" id="searchtype"
                                                    style="padding: 6px 4px;width:100px">
                                                <option value="0">下单账号</option>
                                                <option value="1">订单号</option>
                                            </select>
                                        </div>
                                        <input type="text" name="qq" id="qq3" value="" class="form-control pl-2"
                                               placeholder="请输入要查询的内容（留空则显示最新订单）"
                                               onkeydown="if(event.keyCode==13){submit_query.click()}" required/>
                                        <div class="input-group-append">
                                            <a href="#querydoc" class="btn btn-danger shuaibi-dow0" data-toggle="modal"><i
                                ...
                                <div id="result2" class="form-group" style="display:none;">
                                    <center class="my-1 d-md-none"><small><font
                                                    color="#ff0000">下方表单可以左右滑动哦！</font></small></center>
...
<div class="modal fade" id="querydoc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="bd-example">
                    ...
                    <details>
                        <summary>KF类业务查单教程</summary>
                        <p>例如您购买的是KF商品，需要在浏览器打开您的作品链接，然后查看作品链接里“userid=”后面的字母，输入KF号是一般是查询不到的！</p>
                    </details>
                    <details>
                        <summary>音乐类业务查单教程</summary>
                        <p>例如您购买的是音乐商品，需要在浏览器打开您的作品链接，然后查看作品链接里“user/”后面的字母，输入KF号是一般是查询不到的！</p>
                    </details>
                    <details>
