                            ...
                            <div class="col-lg-5 col-12">
                                <div class="card mb-3" id="gift">
                                    <div class="card-body text-center">
                                        ...
                                        <hr>
                                        <p>
                                            <a class="btn btn-primary btn-block text-white" id="start"
                                               style="display:block;">开始抽奖</a>
                                            <a class="btn btn-danger btn-block text-white" id="stop"
                                               style="display:none;">停止</a>
                                        </p>
                                        <div id="result"></div>
                                    </div>
                                </div>
