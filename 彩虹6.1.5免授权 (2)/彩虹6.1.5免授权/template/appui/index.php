...
<head>
    ...
    <link href="/assets/user/css/load.css" rel="stylesheet"/>
        ...
        <div id="sidebar-scroll">
            <div class="sidebar-content">
                <ul class="sidebar-nav">
                    <li><a href="/" class=" active"><i class="fa fa-home sidebar-nav-icon"></i><span
                                    class="sidebar-nav-mini-hide">网站首页</span></a></li>
                    ...
                    <?php } ?>
                    <li><a href="./user/"><i class="fa fa-lock sidebar-nav-icon"></i><span
                                    class="sidebar-nav-mini-hide">后台登入</span></a></li>
                    ...
                    <li><a target="_blank"
                           href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $conf['kfqq'] ?>&amp;site=qq&amp;menu=yes"><i
                                    class="fa fa-qq sidebar-nav-icon"></i><span
                                    class="sidebar-nav-mini-hide">客服QQ</span></a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="block">
                        <div class="block-title">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#onlinebuy" data-toggle="tab"><i
                                                class="fa fa-check-square-o"></i>&nbsp;在线下单</a></li>
                                <li <?php if ($conf['iskami'] == 0){ ?>class="hide"<?php } ?>><a href="#cardbuy"
                                                                                                 data-toggle="tab"><i
                                                class="fa fa-money"></i>&nbsp;卡密下单</a></li>
                                <li><a href="#query" data-toggle="tab" id="tab-query"><i class="fa fa-search"></i>&nbsp;查询订单</a>
                                </li>
                    ...
                    <a href="javascript:void(0)" class="widget">
                        <div
                            ...
                            <h2 class="widget-heading h3 text-danger">
                                <strong><span><label id="timeShow"></label></span></strong>
                            </h2>
