...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 center-block" style="float: none;">
    ...
    <div class="panel panel-success">
        <div class="panel-body" style="text-align: center;"><img src="<?php echo $logo; ?>" style="max-width: 100%;">
        </div>
    </div>
    <!--logo部分结束-->
    ...
    <div class="panel panel-danger">
        <div class="panel-heading">
            <h3 class="panel-title"><font color="#FFFFFF"><i class=""></i><b>
            ...
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title"><font color="#fff"><i
                                    class="fa fa-shopping-cart"></i>&nbsp;&nbsp;<b>自助下单</b></font><span
                                class="pull-right"><a data-toggle="tab" href="#demo-tabs-box-2" aria-expanded="true"
                                                      class="btn btn-danger btn-rounded"><i class="fa fa-warning"></i> 注意</a></span>
                    </h3>
                </div>
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#onlinebuy" data-toggle="tab"><i class="fa fa-shopping-cart"></i> 下单</a>
                    </li>
                    <li <?php if ($conf['iskami'] == 0){ ?>class="hide"<?php } ?>><a href="#cardbuy"
                                                                                     data-toggle="tab"><i
                                    class="glyphicon glyphicon-th"></i> 卡密</a></li>
                    <li><a href="#query" data-toggle="tab" id="tab-query"><i class="fa fa-search"></i> 查单</a></li>
                    <li <?php if (empty($conf['daiguaurl'])){ ?>class="hide"<?php } ?>><a href="./?mod=daigua"><i
                                    class="fa fa-rocket"></i> 代挂</a></li>
                    <li <?php if ($conf['gift_open'] == 0){ ?>class="hide"<?php } ?>><a href="#gift"
                                                                                        data-toggle="tab"><i
                                    class="fa fa-gift"></i> 抽奖</a></li>
                    <li <?php if (empty($conf['chatframe'])){ ?>class="hide"<?php } ?>><a href="#chat"
                                                                                          data-toggle="tab"><i
                                    class="fa fa-comments"></i> 聊天</a></li>
                    <li <?php if ($conf['fenzhan_buy'] == 0){ ?>class="hide"<?php } ?>><a href="#fenzhan"
                                                                                          data-toggle="tab"><i
                                    class="fa fa-sitemap"></i> 分站</a></li>
                </ul>
                <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="panel panel-primary">
                                        ...
                                        <li class="list-group-item"> 限时超级低价搭建代理分站<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 可享受分站内部超低代理价格<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 可以赚取每一个用户下单的提成<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 可以自定义售卖的商品价格<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 赚取下级分站的每笔交易的提成<span class="badge badge-danger"><i
                                                        class="fa fa-close"></i></span></li>
                                        <li class="list-group-item"> 无限免费搭建下级代理分站<span class="badge badge-danger"><i
                                                        class="fa fa-close"></i></span></li>
                                        <li class="list-group-item"> 分站站长专属的内部售后交流群<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 分站满<?php echo $conf["tixian_min"] ?>元即可申请提现<span
                                                    class="badge badge-success"><i class="fa fa-check"></i></span></li>
                                        <div class="list-group-item list-group-item-warning">
                                            <i class="fa fa-rmb fa-lg grey"
                                        ...
                                        <a data-toggle="modal" href="./user/regsite.php?kind=0" target="_blank"
                                           class="list-group-item list-group-item-info text-center"><strong>马上开通</strong></a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <div class="panel panel-primary">
                                        ...
                                        <li class="list-group-item"> 可以自定义售卖的商品价格<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 赚取下级分站的每笔交易的提成<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 无限免费搭建下级代理分站<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 分站站长专属的内部售后交流群<span class="badge badge-success"><i
                                                        class="fa fa-check"></i></span></li>
                                        <li class="list-group-item"> 分站满<?php echo $conf["tixian_min"] ?>元即可申请提现<span
                                        ...
                                        <a data-toggle="modal" href="./user/regsite.php?kind=1" target="_blank"
                                           class="list-group-item list-group-item-info text-center"><strong>马上开通</strong></a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="panel-body">
                    ...
                    <div id="demo-acc-faq" class="panel-group accordion">
                        <div class="panel panel-trans pad-top"><a href="#demo-acc-faq1"
                                                                  ...
                                                                  data-toggle="collapse" data-parent="#demo-acc-faq">为什么下单很久了都没有开始刷呢？</a>
                        ...
                        <div class="panel panel-trans pad-top"><a href="#demo-acc-faq2"
                                                                  class="text-semibold text-lg text-main"
                                                                  data-toggle="collapse" data-parent="#demo-acc-faq">空间人气下单方法讲解</a>
                            <div id="demo-acc-faq2" class="mar-ver collapse">1.下单前：空间必须是所有人可访问,必须自带1~4条原创说说!<br>2.代刷期间，禁止关闭访问权限，或者删除说说，删除说说的一律由自行负责，不给予补偿。
                            </div>
                        </div>
                        <div class="panel panel-trans pad-top"><a href="#demo-acc-faq3"
                                                                  class="text-semibold text-lg text-main"
                                                                  data-toggle="collapse" data-parent="#demo-acc-faq">说说赞相关下单方法讲解</a>
                        ...
                        <div class="panel panel-trans pad-top"><a href="#demo-acc-faq4"
                                                                  class="text-semibold text-lg text-main"
                                                                  data-toggle="collapse" data-parent="#demo-acc-faq">全民Ｋ歌下单方法讲解</a>
                            <div id="demo-acc-faq4" class="mar-ver collapse">1.打开你的全名k歌<br>2.复制你全名k歌里面的需要刷的歌曲链接<br>3.例如：你歌曲链接是：<font
                                        color="#ff0000">https://kg.qq.com/node/play?s= <font color="green">881Zbk8aCfIwA8U3</font>
                                    &g_f=personal</font><br>4.然后把s=后面的 <font color="green">881Zbk8aCfIwA8U3</font>
                                链接填入到歌曲ID里面，然后提交购买。
                            </div>
                        </div>
                        <div class="panel panel-trans pad-top"><a href="#demo-acc-faq5"
                                                                  class="text-semibold text-lg text-main"
                                                                  data-toggle="collapse" data-parent="#demo-acc-faq">KF代刷下单方法讲解</a>
                            <div id="demo-acc-faq5" class="mar-ver collapse">1.需要填写用户ID和作品ID，比如<font color="#ff0000">http://www.kuaishou.com/i/photo/lwx?userId=
                                    <font color="green">294200023</font> &photoId= <font color="green">1071823418</font></font>
                                (分享作品就可以看到“复制链接”了)<br>2.用户ID就是 <font color="green">294200023</font> 作品ID就是 <font
                                        color="green">1071823418</font> ，然后在分别把用户ID和作品ID填上，请勿把两个选项填反了，不给予补单！
                            </div>
                        </div>
                        <div class="panel panel-trans pad-top"><a href="#demo-acc-faq6"
                                                                  class="text-semibold text-lg text-main"
                                                                  data-toggle="collapse" data-parent="#demo-acc-faq">Q会员/钻下单方法讲解</a>
                            <div id="demo-acc-faq6" class="mar-ver collapse">
                                1.下单之前，先确认输的信息是不是正确的，如果密码输错，那就刷不了了，没到账之前不要改密码<br>2.Q会员/钻因为需要人工处理，所以每天不定时开刷，24小时-48小时内到账！
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="panel panel-danger" <?php if ($conf['bottom'] == ''){ ?>style="display:none;"<?php } ?>>
        <div class="panel-heading"><h3 class="panel-title"><font color="#fff"><i class="fa fa-skyatlas"></i>&nbsp;&nbsp;<b>站点助手</b></font>
            </h3></div>
