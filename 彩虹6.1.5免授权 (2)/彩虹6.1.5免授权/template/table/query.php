            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
                       target="_blank" class="media" style="text-decoration:none">
                        <div class="media-left">
                            <img class="media-object img-circle img-thumbnail img-thumbnail-avatar"
                                 src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $conf['kfqq'] ?>&amp;spec=100"
                                 alt="QQ" style="width:60px;margin:1px">
                        </div>
                        <div class="media-body" style="padding-top:13px">
                            <h5 class="media-heading">本站站长QQ：<span
