...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-5 center-block" style="float: none;">
    ...
    <div class="widget">
        ...
        <center>
            <h2>
                <a href="javascript:void(alert(&#39;<?php echo $conf['sitename'] ?>，建议收藏到浏览器书签哦！&#39;));"><b><?php echo $conf['sitename'] ?></b></a>
            </h2>
        </center>
        <!--logo下面按钮-->
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-default" data-toggle="modal" href="#recommend"><font color="#ff0000"><i
                                        class="fa fa-bolt"></i> 商品推荐</font></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="block-title">
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li style="width: 25%;" align="center" class="active"><a href="#shop"><i
                                class="fa fa-shopping-cart"></i> <b>下单</b></a></li>
                <li style="width: 25%;" align="center" class=""><a href="#search" id="tab-query"><i
                                class="fa fa-search"></i> <b>查询</b></a></li>
                ...
                <li style="width: 25%;" align="center" class=""><a href="#more"><i class="fa fa-list"></i> <b>更多</b></a>
                </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="shop">
                <center>
                    <div class="shuaibi-tip animated tada  text-center"><i class="fa fa-heart text-danger"></i>
                        <b>［<?= date("m月d号") ?>］最新业务通知&nbsp;<a href="#anounce" data-toggle="modal"
                                                               class="label label-danger"><font
                                        color="#FFFFFF">点击查看</font></a></b></div>
                </center>
            ...
            <div class="tab-pane" id="search">
                    ...
                    <tr class="shuaibi-tip animation-bigEntrance">
                        ...
                        <td>
                            ...
                            <i class="fa fa-fw fa-qq text-primary"></i> <?php echo $conf['kfqq'] ?><br><i
                                    class="fa fa-fw fa-history text-danger"></i>售后订单问题请联系客服
                        </td>
                ...
                <input type="submit" id="submit_query" class="btn btn-primary btn-block btn-rounded"
                       style="background: linear-gradient(to right,#87CEFA,#6495ED);color:#fff;" value="立即查询">
                <br>
                ...
                <table class="table table-borderless table-pricing">
                    ...
                    <tr class="active">
                        <td class="btn-effect-ripple"
                            ...
                            <h3 style="width:100%;font-size: 1.6em;">
                                <i class="fa fa-user-o fa-fw" style="margin-top: 0.7em;"></i><strong>入门级</strong> /<i
                                        class="fa fa-user-circle-o fa-fw"></i><strong>旗舰级</strong>
                            </h3>
                            <span style="width: 100%;text-align: center;margin-top: 0.8em;font-size: 1.1em;display: block;"><?php echo $conf['fenzhan_price'] ?>元 / <?php echo $conf['fenzhan_price2'] ?>元</span>
                        </td>
                    </tr>
                    <tr>
                        <td>一模一样的独立网站</td>
                    ...
                    <tr class="active">
                        <td>
                            ...
                            <a href="user/regsite.php" target="_blank" class="btn btn-effect-ripple  btn-danger"
                               style="overflow: hidden; position: relative;"><i class="fa fa-arrow-right"></i> 马上开通</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <div class="panel panel-primary" <?php if ($conf['hide_tongji'] == 1){ ?>style="display:none;"<?php } ?>>
        <div class="panel-heading"><h3 class="panel-title"><font color="#000000"><i class="fa fa-bar-chart-o"></i>&nbsp;&nbsp;<b>数据统计</b></font>
            </h3></div>
    ...
    <div class="modal-dialog panel panel-primary  animation-fadeInQuick2">
        <div class="modal-content">
            <div class="list-group-item reed" style="background:linear-gradient(120deg, #5ED1D7 10%, #71D7A2 90%);">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"></span><span
                            class="sr-only">Close</span></button>
                <center><h4 class="modal-title" id="myModalLabel"><b><font color="#fff">客服与帮助</font></b></h4></center>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="list-group-item reed" style="background:#FFD700;">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">x</span><span
                            class="sr-only">Close</span></button>
                <center><h4 class="modal-title" id="myModalLabel"><b><font color="#fff">下单时显示的“份数”是什么</font></b></h4>
                </center>
            </div>
            <br>
            <center>
                ...
                <hr>
                例如您购买：100个KF粉丝<br>下单份数选5，就是总共会获得500个粉丝
                <hr>
