                    ...
                    <div id="content">
                        ...
                        <div class="mall" id="contentss">
                            ...
                            <div class="alert-danger">
                                <center>&nbsp搭建和本站一模一样的网站！<a href="./?mod=fzjs" class="btn btn-info btn-xs">了解分站</a> <a
                                            target="_blank" href="./user/regsite.php" class="btn btn-danger btn-xs">
                                        点击搭建</a></center>
                            </div>
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#query" data-toggle="tab" id="tab-query">进度查询</a></li>
                                <li><a href="#lqq" data-toggle="tab" style="display:none;">拉圈圈赞</a></li>
                                <li <?php if ($conf['gift_open'] == 0){ ?>class="hide"<?php } ?>><a href="#gift"
                                                                                                    data-toggle="tab">抽奖</a>
                                </li>
                                <li><a href="#chat" data-toggle="tab" style="display:none;">聊天交流</a></li>
                                <li><a href="#admin" data-toggle="tab" style="color:#FF0000">站长后台</a></li>
                            ...
                            <div class="list-group-item">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane fade in active" id="onlinebuy">
                                        ...
                                        <div class="form-group" id="display_selectclass">
                                            <div class="input-group">
                                                ...
                                                <select name="tid" id="cid"
                                                        class="form-control"><?php echo $select ?></select>
                                                <div class="input-group-addon"><span
                                                            class="glyphicon glyphicon-search onclick" title="搜索商品"
                                                            id="showSearchBar"></span></div>
                                            </div>
                                        </div>
                                        <div class="form-group" id="display_searchBar" style="display:none;">
                                            <div class="input-group">
                                                <div class="input-group-addon"><span
                                                            class="glyphicon glyphicon-remove onclick" title="关闭"
                                                            id="closeSearchBar"></span></div>
                                                <input type="text" id="searchkw" class="form-control" placeholder="搜索商品"
                                                       onkeydown="if(event.keyCode==13){$('#doSearch').click()}"/>
                                                <div class="input-group-addon"><span
                                                            class="glyphicon glyphicon-search onclick" title="搜索"
                                        ...
                                        <div class="form-group" id="display_num" style="display:none;">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-addon"><input id="num_min" type="button"
                                                                                      value="-"/></div>
                                                <div class="input-group-addon"><input id="num" name="num"
                                                                                      class="form-control" type="number"
                                                                                      min="1" value="1"/></div>
                                                <div class="input-group-addon"><input id="num_add" type="button"
                                                                                      value="+"/></div>
                                            </div>
                                        </div>
                                        <div id="inputsname"></div>
                                        <div id="alert_frame" class="alert alert-warning" style="display:none;"></div>
                                        <div style="color:blue;margin-top:10px;float:right; text-decoration: underline;"
                                             onclick="qqhao()">什么是球球号？
                                        </div>
                                        <div id="qqhao" style="display:none;"><img src="assets/qiuqiu/images/qqhao.png"
                                                                                   style="width:100%;"/></div>
                                        <div style="clear:both;"></div>

                                        <?php if ($conf['shoppingcart'] == 1) { ?>
                                            <div class="btn-group btn-group-justified form-group">
                                                <a class="btn btn-block btn-success" type="button"
                                                   id="submit_cart_shop">加入购物车</a>
                                                <a type="submit" id="submit_buy"
                                                   class="btn btn-block btn-primary">立即购买</a>
                                            </div>
                                        <?php } else { ?>
                                            <div class="form-group">
                                        ...
                                        <?php } ?>
                                        <div class="panel-body border-t" id="alert_cart" style="display:none;"><i
                                                    class="fa fa-shopping-cart"></i>&nbsp;当前购物车已添加<b
                                                    id="cart_count">0</b>个商品<a class="btn btn-xs btn-danger pull-right"
                                                                               href="./?mod=cart">购物车列表</a></div>
                                    ...
                                    <div class="tab-pane fade in" id="query">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <font color="blue">
                                                        <b>客服: </b></font><img src="assets/qiuqiu/images/auth.gif"
                                                                               title="正版认证"><br>
                                                    <img src="http://q1.qlogo.cn/g?b=qq&amp;nk=<?php echo $conf['kfqq'] ?>&amp;s=100"
                                                         alt="Avatar" width="40" height="40"
                                                         style="border:1px solid #FFF;-moz-box-shadow:0 0 3px #AAA;-webkit-box-shadow:0 0 3px #AAA;border-radius: 50%;box-shadow:0 0 3px #AAA;padding:3px;margin-right: 3px;margin-left: 6px;"></font></br>
                                                    <a target="_blank"
                                                       href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
                                                       class="btn btn-primary btn-xs">QQ：<?php echo $conf['kfqq'] ?></a><br>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-btn">
                                                    <select class="form-control" id="searchtype"
                                                            style="padding: 6px 0;width:90px">
                                                        <option value="0">下单账号</option>
                                                        <option value="1">订单号</option>
                                                    </select>
                                                </div>
                                                <input type="text" name="qq" id="qq3" value="<?php echo $qq ?>"
                                                       class="form-control" placeholder="请输入要查询的内容（留空则显示最新订单）"
                                    ...
                                    <div class="tab-pane fade in" id="admin">
                                        <div class="alert alert-info">本站支持搭建分站，分站仅需8.88元，全自动自助搭建！<a target="_blank"
                                                                                                    href="./?mod=fzjs"
                                                                                                    class="btn btn-info btn-xs">了解分站</a>
                                            <a target="_blank" href="./user/regsite.php" class="btn btn-danger btn-xs">
                                                点击搭建</a>
                                        </div>
                                        <div class="modal-body">
                                            <form action="./user/login.php" method="post" class="form-horizontal"
                                                  role="form">
                                                <div class="input-group"><span class="input-group-addon">管理员账号</span>
                                                    <input type="text" name="user" value="" class="form-control"
                                                           placeholder="管理员账号" required="required"></div>
                                                <br>
                                                <div class="input-group"><span class="input-group-addon">管理员密码</span>
                                                    <input type="password" name="pass" class="form-control"
                                                           placeholder="管理员密码" required="required"></div>
                                                <br>
                                                <div class="form-group">
                                                    <div class="col-xs-12"><input type="submit" value="登陆分站管理员系统"
                                                                                  class="btn btn-primary form-control">
                                                    </div>
                                                </div>
                                                <input type="submit" value="登陆主站管理员系统"
                                                       class="btn btn-primary form-control">
                                        </div>
                                    </div>
                                </div>
