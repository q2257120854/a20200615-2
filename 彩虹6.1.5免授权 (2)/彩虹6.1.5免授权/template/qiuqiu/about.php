...
?>
    ...
    <div class="about">
        ...
        <div class="wxdy"><span>客服QQ</span> <em><?php echo $conf['kfqq'] ?><a target="_blank"
                                                                              href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes">
                    <img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo $conf['kfqq'] ?>:51" alt="点击这里给我发消息"
                         title="点击这里给我发消息"/></a></em></div>
