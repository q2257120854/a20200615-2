    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li class="" onclick="activeselect(this)"><a href="./"><i class="layui-icon layui-icon-cart"></i>
                        在线下单</a></li>
                <li class="active" onclick="activeselect(this)"><a href="./?mod=query"><i
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <img src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $conf['kfqq'] ?>&amp;spec=100"
                                                 alt="Avatar" width="50" height="50" class="qqimg"><br>
                                            <a target="_blank"
                                               href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq'] ?>&site=qq&menu=yes"
                                               class="btn btn-info btn-xs">QQ：<?php echo $conf['kfqq'] ?></a><br>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="layui-form-item">
                                <div class="input-group">
                                    <div class="input-group-btn" style="width:100px">
                                        <select class="layui-input" id="searchtype" style="padding: 6px 4px;">
                                            <option value="0">下单账号</option>
                                            <option value="1">订单号</option>
                                        </select>
                                    </div>
                                    <input type="text" name="qq" id="qq3" value="<?php echo $qq ?>" class="layui-input"
                                           placeholder="请输入下单账号（留空则根据浏览器缓存查询）"
                                    ...
                                    <span class="input-group-btn"><a href="#cxsm" data-toggle="modal"
                                                    ...
                                                    class="layui-icon layui-icon-help"></i></a></span>
                                </div>
                            </div>
                        </div>
                        <button type="submit" id="submit_query" class="layui-btn layui-btn-primary btn-block">立即查询
                        </button>
                        <hr>
