...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 center-block" style="float: none;">
    ...
    <div class="panel panel-info">
        <div class="list-group-item reed" style="background:#64b2ca;"><h3 class="panel-title"><font color="#fff"><i
                            class="fa fa-shopping-cart"></i>&nbsp;&nbsp;<b>自助下单</b></font></h3></div>
        <ul class="nav nav-tabs">
            <li class="active"><a href="#onlinebuy" data-toggle="tab">下单</a></li>
            <li <?php if ($conf['iskami'] == 0){ ?>class="hide"<?php } ?>><a href="#cardbuy" data-toggle="tab">卡密</a>
            </li>
            <li><a href="#query" data-toggle="tab" id="tab-query">查单</a></li>
            <li <?php if ($conf['gift_open'] == 0){ ?>class="hide"<?php } ?>><a href="#gift" data-toggle="tab">抽奖</a>
            </li>
            <li <?php if (empty($conf['daiguaurl'])){ ?>class="hide"<?php } ?>><a href="./?mod=daigua">代挂</a></li>
            <li <?php if (empty($conf['chatframe'])){ ?>class="hide"<?php } ?>><a href="#chat" data-toggle="tab">聊天</a>
            </li>
            <li <?php if ($conf['fenzhan_buy'] == 0){ ?>class="hide"<?php } ?>><a href="./user/regsite.php"
                                                                                  style="color:red">开通分站</a></li>
            <?php if ($islogin2 == 1) { ?>
    ...
    <div class="panel panel-info" <?php if ($conf['hide_tongji'] == 1){ ?>style="display:none;"<?php } ?>>
        <div class="list-group-item reed" style="background:#64b2ca;"><h3 class="panel-title"><font color="#fff"><i
                            class="fa fa-bar-chart"></i>&nbsp;&nbsp;<b>运行日志</b></font></h3></div>
        <table class="table table-bordered">
            <tbody>
            <tr>
                <td align="center"><font color="#808080"><b>平台已经运营</b></br><i class="fa fa-hourglass-2 fa-2x"></i></br>
                        <span id="count_yxts"></span>天</font></td>
                <td align="center"><font color="#808080"><b>业务订单总数</b></br><span
                                class="fa fa-shopping-cart fa-2x"></span></br><span id="count_orders"></span>条</font>
                </td>
            </tr>
            <tr height=50>
                <td align="center"><font color="#808080"><b>已处理的订单</b></br><i
                                class="fa fa-check-square-o fa-2x"></i></span></br><span
                                id="count_orders1"></span>条</font></td>
                <td align="center"><font color="#808080"><b>您共访问本站</b></br><i
                                class="fa fa-internet-explorer fa-2x"></i></span></br><span
                                id="counter">1</span>次</font></td>
            <tbody>
        </table>
    </div>
