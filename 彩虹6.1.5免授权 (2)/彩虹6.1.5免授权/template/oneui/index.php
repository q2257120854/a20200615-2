...
<!--弹出公告-->
<!--公告-->
<div class="modal fade" align="left" id="mustsee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
...
<div class="col-xs-12 col-sm-10 col-md-8 col-lg-5 center-block" style="float: none;">
    ...
    <div class="block block-link-hover3" href="javascript:void(0)">
        ...
        <div class="block-content block-content-mini block-content-full bg-gray-lighter">
            <div class="text-center text-muted">
                <div class="btn-group">
                    <div class="btn-group">
                        <a class="btn btn-default" data-toggle="modal" href="#mustsee"><font color="#ff0000"><i
                                        class="fa fa-wifi"></i>
                                平台公告</a></font>
                    </div>
                    <?php if ($islogin2 == 1) { ?>
                        <div class="btn-group">
                            <a href="./user/" class="btn btn-effect-ripple btn-default"><i
                                        class="glyphicon glyphicon-user"></i> <span style="font-weight:bold">管理后台</span></a>
                        </div>
                    <?php } else { ?>
                        <div class="btn-group">
                            <a href="./user/login.php" class="btn btn-effect-ripple btn-default"><i
                                        class="glyphicon glyphicon-user"></i> <span
                                        style="font-weight:bold">登录</span></a>
                        </div>
                        <div class="btn-group">
                            <a href="./user/reg.php" class="btn btn-effect-ripple btn-default"><i
                                        class="glyphicon glyphicon-plus"></i> <span
                                        style="font-weight:bold">注册</span></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <div class="block block-themed">
        ...
        <marquee direction="up" behavior="scroll" loop="3" scrollamount="3" scrolldelay="10" align="top"
                 bgcolor="#ffffff" height="200px" width="93%" hspace="20" vspace="10" onmouseover="this.stop()"
                 onmouseout="this.start()"
                 style="background-color: rgb(255, 255, 255); height: 200px; width: 93%; margin: 10px 20px;">
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户132***988说：<b>从你们网站刚开我就搭建了个分站，这么多天也赚了两千多了，你们挺诚信的</b>
            </div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户216***675说：<b>在你这搭建了个专业版分站，我要努力宣传！争取一天提现50+元！！！</b>
            </div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户111***684说：<b>666，终于更新了抽奖</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户203***337说：<b>卧槽，这个真人名片赞速度真他妈快，3分钟刷了4万多</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户292***724说：<b>非常不错</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户217***359说：<b>多做这中活动</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户136***498说：<b>希望能迅速赞</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户212***285说：<b>hao</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户318***115说：<b>应该尽量的保证质量，并设置分享有奖，这样，也吸引了客户</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户159***280说：<b>每天送100名片赞</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户265***010说：<b>类似于QQ空间里说说的赞，能不能设置指定数量？希望采纳</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户486***443说：<b>更好</b></div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户316***940说：<b>应该把全民k歌刷花间单的</b></div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户154***984说：<b>我帮你们的网站分享给了很多群，永远支持你们</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户238***434说：<b>刷赞</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户239***848说：<b>炫酷点 再加点音乐就好了</b></div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户321***995说：<b>QQ代刷网是全国最大的代刷网平台,主打QQ钻业务,KF刷粉丝软件,空间业务,进货价格便宜</b>
            </div>
            <div class="gg_info" style="margin: 0;color:blue">用户210***769说：<b>非常好，以后要来就来这里</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户325***178说：<b>QQ代刷网，<?php echo $_SERVER['HTTP_HOST']; ?>
                    ，24小时自助下单平台</b></div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">
                用户356***078说：<b>24小时自助下单平台<?php echo $_SERVER['HTTP_HOST']; ?>，QQ代刷网，<?php echo $conf['sitename'] ?></b>
            </div>
            <div class="gg_info" style="margin: 0;color:blue">用户155***605说：<b>很好啊</b></div>
            <div class="gg_info" style="margin: 0;color:blue">
                用户954***293说：<b>代刷网真是不错，一直用的这个网站，QQ代刷网，<?php echo $_SERVER['HTTP_HOST']; ?>，代刷网，搭建代刷网</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户314***137说：<b>希望多出来刷东西的</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户532***563说：<b>平台很棒啊，支持<?php echo $conf['sitename'] ?>
                    ，自助下单平台</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户532***563说：<b>24小时自助下单代刷QQ名片赞,空间人气,KF粉丝,KF作品双击喜欢,KF作品播放量,全民K歌粉丝 </b>
            </div>

            <div class="gg_info" style="margin: 0;color:blue">用户280***172说：<b></b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户111***684说：<b>价格再合理一点</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户203***337说：<b>这个平台特别棒，，，，真的特别特别棒</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户292***724说：<b>非常不错</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户217***359说：<b>多做这中活动</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户136***498说：<b>希望能迅速赞</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户212***285说：<b>hao</b></div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户321***803说：<b>多做一些宣传</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户213***668说：<b>666</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户321***995说：<b>好了</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户532***563说：<b>24小时自助下单平台,免登陆的虚拟业务在线自动处理平台,专业为QQ空间,全民K歌,KFGIF,新浪微博,火山视频等业务提供代刷服务,最大的空间业务代刷平台 <?php echo $_SERVER['HTTP_HOST']; ?></b>
            </div>
            <div class="gg_info" style="margin: 0;color:blue">用户210***769说：<b>非常好，以后要来就来这里</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户325***178说：<b>更好宣传</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户325***178说：<b>刷更多的赞</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户168***382说：<b>666</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户353***251说：<b>很有诚信，刷的很快，推荐这个平台</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户852***349说：<b>要是能有宣传功能的话，这个平台肯定更受欢迎</b></div>
            ...
            <div class="gg_info" style="margin: 0;color:blue">用户343***331说：<b>免费的再多点</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户340***317说：<b>速度快</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户356***078说：<b>刷豪华黄钻</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户155***605说：<b>很好啊</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户954***293说：<b>好好努力</b></div>
            <div class="gg_info" style="margin: 0;color:blue">用户314***137说：<b>希望多出来刷东西的</b></div>
        </marquee>
    </div>
    ...
    <!--底部导航-->
    <div class="block">
        <div class="block-content text-center"><p><span style="font-weight:bold"><?php echo $conf['sitename'] ?> <i
                            class="fa fa-heart text-danger"></i> 2019 | </span><a class="" href="#customerservice"
                                                                                  style="font-weight:bold"
                                                                                  data-toggle="modal">客服与帮助</span></a>
            </p>
        </div>
    </div>
    <!--底部导航-->
