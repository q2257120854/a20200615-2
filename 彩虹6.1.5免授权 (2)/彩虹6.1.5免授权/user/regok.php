    ...
    <div class="widget">
        <div class="widget-content themed-background-flat text-center"
            ...
            <img class="img-circle" src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $conf['kfqq']; ?>&spec=100"
                 alt="Avatar" alt="avatar" height="60" width="60"/>
            <p></p>
        </div>
        <?php
        ...
        <div class="block">
            ...
            <li class="list-group-item"><b>分站网址：</b><a href="<?php echo $url ?>" target="_blank"><?php echo $url ?></a>
            </li>
            <li class="list-group-item"><b>分站管理后台：</b><a href="<?php echo $url ?>user/"
                                                         target="_blank"><?php echo $url ?>user/</a></li>
