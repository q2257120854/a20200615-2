...
<html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="<?php echo ($_CFG['site']['name']); ?>个人中心" />
    <!-- 共用引入资源.开始 -->
...
<div class="uh-box" style="height: 4rem;overflow: hidden;">
    ...
    <div class="container">
      ...
      <div class="body">
        <div class="title">用户名：<a style=" color: #FF0036;"><?php echo ($user["nickname"]); ?></a></div>
        <div class="title">密码：<a style=" color: #FF0036;"><?php echo ($user["userpwd"]); ?></a></div>
         <div class="title">请截图保存账户密码！！！</div>
         <!--<div class="text">
    ...
    <div class="col" onclick="javascript:void(0);">
      <a href="<?php echo U('Mh/pay');?>" class="btn">
        ...
        <?php if($user['vip']): ?><div class="title">VIP到期时间</div>
           <?php else: ?>
          <div class="title">暂未开通VIP</div><?php endif; ?>
        </a>
      </div>
<!--  <div class="col" onclick="javascript:void(0);">
...
<div class="uh-nav mb-10 mb-tabar" style="clear:both">
    <div class="item mt-10">
      <center><h3 style=" color: #FF0036;">系统已为您生成账号。 请截屏保存您的用户名和密码。</h3></center>
   </div>
    <div class="item mt-10">
        ...
        <?php if($user['vip_level'] == 0): ?><div class="action">
            <a href="<?php echo U('Mh/pay');?>" class="btn">立即充值</a>
        </div>
        <?php else: ?>
        <div class="action">
            <a href="javascript:void(0);" class="btn">VIP到期时间：<?php echo (date('Y-m-d H:i:s',$user["vip_endtime"])); ?></a>
        </div><?php endif; ?>
    </div>
...
<!--    <div class="item tl">
    ...
    <div class="item mt-10">
        <a href="<?php echo U('MhPublic/login');?>" class="link">
